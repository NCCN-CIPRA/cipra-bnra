/* eslint-disable no-restricted-globals */ // import { RiskCalculation } from "../../types/dataverse/DVAnalysisRun";
...
import runAnalysis from"./runAnalysis";// export interface CalculatorParams {
...
//   });
// };
self.onmessage=function(e){var calcs=runAnalysis(e.data,function(progress){return self.postMessage({type:"progress",value:progress});});self.postMessage({type:"result",value:calcs});};export{};// export default () => {
