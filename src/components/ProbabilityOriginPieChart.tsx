...
export default function ProbabilityOriginPieChart({ riskFile }: { riskFile: any }) {
  if (!riskFile) return null;

  const dataGlobal = [
    {
      name: "Direct Probability",
      value: riskFile.calculated.dp,
      color: "rgba(214, 48, 49,1.0)",
      total: riskFile.calculated.tp,
    },
    {
      name: "Indirect Impact",
      value: riskFile.calculated.ip,
  ...
  return (
    <>
      <Box sx={{ width: "100%", textAlign: "center" }}>
        <Typography variant="h6">Probability Origin</Typography>
      </Box>
