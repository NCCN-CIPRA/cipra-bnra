    ...
    <>
      ...
      >
        ...
        {t("ccchart.lessColdWeath.3", "weather") !== "-" && (
          <tspan x={l + viewBox.width * (1 / 9)} dy="1.2em" textAnchor="middle">
            {t("ccchart.lessColdWeath.3", "weather")}
          </tspan>
        )}
      </text>
      <path
        ...
        fill="none"
        stroke="#00000090"
        d={`M ${l + viewBox.width * (1 / 9)} ${
          b - viewBox.height * 0.2 + 10
        } Q ${l + viewBox.width * (1 / 9)} ${
          b -
          viewBox.height * 0.2 +
          10 +
          (b -
            viewBox.height * (norm(1.5 - 4) / 0.5) -
            10 -
            (b - viewBox.height * 0.2 + 10)) /
            2
        } ${l + viewBox.width * (1.5 / 9)} ${
          b - viewBox.height * (norm(1.5 - 4) / 0.5) - 10
        }`}
      />
    </>
  );
  ...
  return (
    <>
      ...
      <path
        ...
        fill="none"
        stroke="#00000090"
        d={`M ${l + viewBox.width * (6.5 / 9)} ${
          b - viewBox.height * 0.65 + 10
        } Q ${l + viewBox.width * (6.5 / 9)} ${
          b -
          ...
          (b -
            ...
            (b - viewBox.height * 0.65 + 10)) /
            2
        } ${l + viewBox.width * (6 / 9) + 10} ${
          b - viewBox.height * (norm(6 - 5) / 0.5) - 10
        }`}
      />
    </>
  );
  ...
  return (
    <>
      ...
      <path
        ...
        fill="none"
        stroke="#00000090"
        d={`M ${l + viewBox.width * (7.5 / 9)} ${
          b - viewBox.height * 0.25 + 10
        } Q ${l + viewBox.width * (7.5 / 9)} ${
          b -
          ...
          (b -
            ...
            (b - viewBox.height * 0.25 + 10)) /
            2
        } ${l + viewBox.width * (7 / 9) + 10} ${
          b - viewBox.height * (norm(7 - 5) / 0.5) - 10
        }`}
      />
    </>
  );
