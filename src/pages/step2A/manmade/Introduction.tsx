    ...
    <Box style={{ position: "relative" }}>
      ...
      <Stack sx={{ mb: 4, ml: 1 }} rowGap={2}>
        <Typography variant="body2">
          <Trans i18nKey="2A.manmade.introduction.info.1">
            Welcome to the second step in the risk analysis process, <b>Risk Analysis A</b>!
          </Trans>
        </Typography>
        <Typography variant="body2">
          <Trans i18nKey="2A.manmade.introduction.info.2">
        ...
        <Typography variant="body2">
          <Trans i18nKey="2A.manmade.introduction.info.3">
        ...
        <Typography variant="body2">
          <Trans i18nKey="2A.manmade.introduction.info.31">
            Binnen de 3 hooddelen zal u gevraagd worden om een de directe waarschijnlijkheid en de directe impacten van
            de intensiteitsscenario’s van het bestudeerde risico kwantitatief in te schatten en deze vervolgens
            kwalitatief te onderbouwen. U kunt de kwantitatieve schalen oproepen via de “informatie” knop die u
            terugvindt links onderaan uw scherm. Hierop vindt u naast de waarden gekoppeld aan de verschillende klassen
            (0 – 5) ook een beschrijving terug van de verschillende in te schatten parameters en verklarende concrete
            voorbeelden.
          </Trans>
        </Typography>
        <Typography variant="body2">
          <Trans i18nKey="2A.manmade.introduction.info.4">
