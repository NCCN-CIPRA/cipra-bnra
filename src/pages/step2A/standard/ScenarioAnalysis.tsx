...
export function validateScenarioInputs(inputs: ScenarioInput, riskType: string | undefined): (keyof ScenarioInput)[] {
  if (riskType === "Malicious Man-made Risk") {
    return [
      ...(inputs.cr4de_dp_quanti === null ? ["cr4de_dp_quanti" as keyof ScenarioInput] : []),
      ...(inputs.cr4de_dp_quali === null ? ["cr4de_dp_quali" as keyof ScenarioInput] : []),
    ];
  }
