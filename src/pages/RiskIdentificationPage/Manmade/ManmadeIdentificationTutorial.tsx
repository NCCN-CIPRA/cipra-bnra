        ...
        <Box sx={{ textAlign: "left" }}>
          <Typography variant="body1" my={2}>
            <Trans i18nKey="rfDescription.m.tutorial.3.1">
              Each <b>Malicious Actors Risk File</b> is divided into 3 actor groups which are characterised by their
              levels of capabilities; i.e. actor groups with “<i>considerable</i>", “<i>major</i>" and "<i>extreme</i>"
              capabilities.
            </Trans>
          </Typography>
          <Typography variant="body1" my={2}>
            <Trans i18nKey="rfDescription.m.tutorial.4.1">
              This sections provides a more in-depth description of the <i>Most Relevant Actor Group</i>.
            </Trans>
          </Typography>
          <Typography variant="body1" my={2}>
