...
export default function RiskIdentificationPage() {
  ...
  const { user, hazardCatalogue, riskFile, causes, effects, catalyzingEffects } =
  ...
  const processedRiskFile = useMemo(() => {
  ...
  return (
    <Container>
      ...
      <CascadeSections
        riskFile={riskFile}
        otherHazards={hazardCatalogue}
        causes={causes}
        effects={effects}
        catalysing={catalyzingEffects}
        attachments={attachments}
        setIsSaving={setIsSaving}
        onUpdateCascades={async () => {}}
