  ...
  return (
    <Paper sx={{ p: 2, mx: 2, mb: 2, pb: 1 }}>
      <Dialog open={confirmDialog} onClose={() => setConfirmDialog(false)}>
        <DialogContent>
          <Trans i18nKey="2A.noComment.confirm">
            Are you sure you wish to remove your comment?
          </Trans>
        </DialogContent>
        <DialogActions>
        ...
        <Alert severity="error" sx={{ mb: 2 }}>
          <Typography>
            <Trans i18nKey="2A.error.quali.required">
              Please enter a comment. If you have absolutely nothing to comment,
              please press the &#quot;No Comment&#quot; button.
            </Trans>
          </Typography>
        </Alert>
      )}
      {noComment ? (
        <Alert severity="info">
          <AlertTitle>
            <Trans i18nKey="2A.noComment.title">
              You have chosen not to comment on this section
            </Trans>
          </AlertTitle>
          <Trans i18nKey="2A.noComment.1">
            Please be aware that we really need the qualitative explanation to
            understand the quantitative results etc.
          </Trans>
        </Alert>
      ) : (
        <TextInputBox
              ...
              return (
                ...
                >
                  <TableCell component="th" scope="row">
                    ...
                    {isDownloading === a.cr4de_bnraattachmentid && (
