          ...
          >
            <Stack direction="column">
              ...
              <Typography variant="subtitle1" paragraph>
                <Trans i18nKey="methodology.framework.scales.subtitle">
                  Standard scales for probability and impact indicators
                </Trans>
              </Typography>
            </Stack>
          </Container>
          ...
          <Container>
            <Box>
              <Typography variant="body1" paragraph>
                {/* <Trans i18nKey="methodology.scales.introduction.1"> */}
                ...
                >
                  ...
                  <CardContent sx={{ flex: 1 }}>
                    <Typography
                      ...
                      sx={{ height: 30 }}
                    >
                      <Trans i18nKey="methodology.scales.probability.title">
                        Probability
                      </Trans>
                    </Typography>
                    <Typography
                    ...
                    >
                      <Trans i18nKey="methodology.scales.probability.description.1">
                        The probability scales determine the likelihood that an
                        event comparable to a given risk scenario will take
                        place.
                      </Trans>
                    </Typography>
                  </CardContent>
                ...
                >
                  ...
                  <CardContent sx={{ flex: 1 }}>
                    <Typography
                      ...
                      sx={{ height: 30 }}
                    >
                      <Trans i18nKey="methodology.scales.impact.human.title">
                        Human Impact
                      </Trans>
                    </Typography>
                    <Typography
                    ...
                    >
                      <Trans i18nKey="methodology.scales.impact.human.introduction">
                ...
                >
                  ...
                  <CardContent sx={{ flex: 1 }}>
                    <Typography
                      ...
                      sx={{ height: 30 }}
                    >
                      <Trans i18nKey="methodology.scales.impact.societal.title">
                        Societal Impact
                      </Trans>
                    </Typography>
                    <Typography
                      ...
                      sx={{ color: "text.secondary" }}
                    >
                      <Trans i18nKey="methodology.scales.impact.societal.introduction">
                        The indicators for the societal impact determine the the
                        magnitude of supply shortfalls and unmet human needs
                        (Sa), diminished public order and domestic security
                        (Sb), damage to the reputation of Belgium abroad (Sc)
                        and a loss of confidence in or functioning of the state
                        and/or its values (Sd) as a result of the event.
                      </Trans>
                    </Typography>
                  </CardContent>
                  <CardActions>
                ...
                >
                  ...
                  <CardContent sx={{ flex: 1 }}>
                    <Typography
                      ...
                      sx={{ height: 30 }}
                    >
                      <Trans i18nKey="methodology.scales.impact.environmental.title">
                        Environmental
                      </Trans>
                    </Typography>
                    <Typography
                      ...
                      sx={{ color: "text.secondary" }}
                    >
                      <Trans i18nKey="methodology.scales.impact.environmental.introduction">
                        The indicators for the environmental impact determine
                        the damage to ecosystems (Ea).
                      </Trans>
                    </Typography>
                  </CardContent>
                  <CardActions>
                ...
                >
                  ...
                  <CardContent sx={{ flex: 1 }}>
                    <Typography
                      ...
                      sx={{ height: 30 }}
                    >
                      <Trans i18nKey="methodology.scales.impact.financial.title">
                        Financial Impact
                      </Trans>
                    </Typography>
                    <Typography
                      ...
                      sx={{ color: "text.secondary" }}
                    >
                      <Trans i18nKey="methodology.scales.impact.financial.introduction">
            ...
            >
              ...
              >
                <Trans i18nKey="landingpage.questions1">
                  Questions, suggestions or other? Please don&#quot;t hesitate
                  to contact us!
                </Trans>
              </Typography>
              <Typography
                ...
                <li>
                  <Typography variant="body2">
                    <Trans i18nKey="learning.probability2050.text.introduction.2">
                      The return period, i.e. the timespan expressed in years
                      during which statistical computations or estimates expect
                      a given event to occur at least once on average. It is
                      expressed as occurring once every x years.
                    </Trans>
                  </Typography>
                </li>
                <li>
                ...
                <li>
                  <Typography variant="body2">
                    <Trans i18nKey="learning.probability2050.text.introduction.4">
                      The 10 year likelihood, i.e. the probability of a given
                      event occurring at least once during the next 10 years.
                      Always takes a value between 0 and 100%.
                    </Trans>
                  </Typography>
                </li>
            ...
            <Box sx={{ mb: 4 }}>
              <Typography variant="body1" paragraph>
                <Trans i18nKey="learning.motivation.text.introduction.1">
                  There are several factors which make it impossible to reach a
                  definitive conclusion on the likelihood of occurrence
                  (frequency) of maliciously induced events (e.g. terrorist
                  attacks, political events and armed conflicts). They include
                  the unpredictability of the actors; the fluctuating
                  willingness to act and react to evolving security situations
                  and the resulting fast-changing threat landscapes, as well as
                  the lack of statistically useful case numbers.
                </Trans>
              </Typography>
              <Typography variant="body1" paragraph>
                <Trans i18nKey="learning.motivation.text.introduction.2">
                  An alternative methodology is proposed that makes use of
                  well-known parameters in the intelligence service community,
                  such as ability and motivation, as well as some assumptions
                  about the behaviour of intelligent and malicious actors.
                </Trans>
              </Typography>
              <Typography variant="body1" paragraph>
                <Trans i18nKey="learning.motivation.text.introduction.3">
                  The probability should be read as the chance that the actor
                  would execute any attack within their capabilities between now
                  and 3 years.
                </Trans>
              </Typography>
            </Box>
            ...
            <Box sx={{ mb: 4 }}>
              <Typography variant="body1" paragraph>
                <Trans i18nKey="learning.cp.text.introduction.1">
                  ...
                  conditional probabilities should be established between the
                  different intensity scenarios of the cause and the effect.
                  This is the estimated probability that an incident of the
                  (effect) risk in question will occur, given the fact that an
                  incident of the causing risk has already occurred.
                </Trans>
              </Typography>
              <Typography variant="body1" paragraph>
                <Trans i18nKey="learning.cp.text.introduction.2">
                  For example, an earthquake of an extreme intensity has about
                  95% chance of causing a major ‘failure of electricity supply’,
                  which corresponds to CP5. Note that each cause-effect
                  relationship with 3 intensity scenarios (considerable, major,
                  extreme) requires 9 estimations of conditional likelihood.
                </Trans>
              </Typography>
            </Box>
            ...
            <Box sx={{ mb: 8 }}>
              <Typography variant="body1" paragraph>
                <Trans i18nKey="learning.impact.text.introduction">
                  ...
                  indicator, there are five damage extent classes, along with
                  the ranges of their respective measurement units. These damage
                  classes are logarithmically cumulative .
                </Trans>
              </Typography>
              ...
              <Typography variant="body1" paragraph>
                <Trans i18nKey="learning.impact.h.introduction">
                  The indicators for the human impact scale record the effects
                  of a hazard on the lives (Ha), physical integrity and mental
                  health (Hb) of the general public. Hc captures those
                  ...
                  <Box sx={{ mb: 8, ml: 3 }}>
                    <Typography variant="body1" paragraph>
                      <Trans i18nKey="learning.impact.hb.introduction.1">
                        The Hb indicator includes the number of people affected
                        by injuries or diseases that can be directly attributed
                        to the event. The indicator takes into account physical
                        and mental illnesses or injuries connected to the
                        hazard.
                      </Trans>
                    </Typography>
                    <Typography variant="body1" paragraph>
                      <Trans i18nKey="learning.impact.hb.introduction.2">
                        The basic units for this indicator are all people who
                        suffer an injury, illness (incl. due to endocrine
                        disruption) as a result of the event. The three levels
                        of severity outlined below should be assessed
                        accordingly. Differing degrees of injury severity are
                        aggregated using weighting factors.
                      </Trans>
                    </Typography>
                    <Typography variant="body1" paragraph>
                      <Trans i18nKey="learning.impact.hb.introduction.3">
                        Individuals who succumb to their injuries or illness are
                        counted not under this indicator, but under Ha –
                        ...
                        indicator Hc – People in need of assistance. Individuals
                        suffering from psychological trauma (e.g. post-traumatic
                        stress disorder) resulting in impingement upon or unduly
                        restricting their daily life are covered by indicator Sb
                          ...
                          <TableRow>
                            ...
                            <TableCell sx={{ width: "16.6%" }}>
                              <Trans i18nKey="learning.impact.hb.injury.3">
                                No permanent physical harm; medical attention,
                                but no hospital stay
                              </Trans>
                            </TableCell>
                            <TableCell sx={{ width: "16.6%" }}>
                              <Trans i18nKey="learning.impact.hb.illness.3">
                                Minor illness requiring medical treatment; full
                                recovery
                              </Trans>
                            </TableCell>
                            <TableCell sx={{ width: "16.6%" }}>
                          ...
                          <TableRow>
                            <TableCell colSpan={10}>
                              <Trans i18nKey="learning.impact.hb.level.footer">
                                Injury and illness weighted according to their
                                degree of severity
                              </Trans>
                            </TableCell>
                          </TableRow>
                  ...
                  <Box sx={{ mb: 8, ml: 3 }}>
                    <Typography variant="body1" paragraph>
                      <Trans i18nKey="learning.impact.hc.introduction.1">
                        ...
                        during, and after an event. This may involve, for
                        instance, housing in emergency shelters; supplying food
                        to people in locations cut off from the outside world;
                        or giving emergency psychological assistance to people
                        who are not, however, affected by actual mental
                        illnesses. The duration of assistance required by the
                        directly affected persons is registered. Effects such as
                        supply shortfalls and disruptions for large parts of the
                        population are counted not under Hc, but under the
                        indicator Sa – Supply shortfalls and service
                        disruptions.
                      </Trans>
                    </Typography>
                    <Typography variant="body1" paragraph>
                      <Trans i18nKey="learning.impact.hc.introduction.2">
                        ...
                        person day. This is determined by multiplying the number
                        of people requiring assistance with the duration of
                        impairment in days . The effective duration of
                        assistance required by all individuals is added up. The
                        minimum unit per person is one day. The duration of the
                        requirement for assistance is counted, rather than the
                        period in which assistance services are provided. For
                        instance, one would count the number of days during
                        which the total number of traumatised individuals
                        require emergency psychological assistance, rather than
                        the duration for which the members of care-providing
                        organisations have been deployed.
                      </Trans>
                    </Typography>
                    <Typography variant="body1" paragraph>
                      <Trans i18nKey="learning.impact.hc.introduction.3">
                        The cost of providing support services is accounted for
                        in the indicator Fa – Financial asset damages.
                      </Trans>
                    </Typography>
                          ...
                          <TableRow>
                            <TableCell colSpan={10}>
                              <Trans i18nKey="learning.impact.hc.footer">
                                Unit: person days (number of people multiplied
                                by days in need of assistance)
                              </Trans>
                            </TableCell>
                          </TableRow>
                        </TableFooter>
              ...
              <Typography variant="body1" paragraph>
                <Trans i18nKey="learning.impact.s.introduction">
                  ...
                  disruptions caused by the hazard under investigation. On the
                  one hand, these may include the effects on the Belgian
                  population, e.g. through supply shortfalls and disruptions
                  (Sa) or diminished public order and domestic security (Sb). On
                  the other hand, it captures the effects on the state: damage
                  to the reputation of Belgium abroad (Sc) and a loss of
                  confidence in or functioning of the state and/or its values
                  (Sd).
                </Trans>
              </Typography>
                  ...
                  <Box sx={{ mb: 8, ml: 3 }}>
                    <Typography variant="body1" paragraph>
                      <Trans i18nKey="learning.impact.sa.introduction.1">
                        This indicator measures breakdowns or severe disruptions
                        to the supply of critical goods and services to the
                        entire population or parts of it. They are grouped into
                        three sets according to their importance.
                      </Trans>
                    </Typography>
                    <Typography variant="body1" paragraph>
                      <Trans i18nKey="learning.impact.sa.introduction.2">
                        Supply shortfalls are calculated by multiplying the
                        number of persons affected with the duration (in days)
                        for which their needs are not met. The effective
                        duration of the disruption for those affected is added
                        together. Additionally, a distinction should be made
                        between needs of varying importance. The human need for
                        water and food is obviously more immediately important
                        than the need for postal and courier services. Physical
                        needs are to be fulfilled if the individual is to
                        survive, whereas the next categories rather ensure the
                        security and comfort needs. To model this fact, a
                        weighting factor is given to each need which should be
                        applied in the final calculations. Notice that there may
                        exist some cascading effects between unmet needs, i.e.
                        if the need for electricity is not met, usually the need
                        for telecommunication will also not be met. This effect
                        is not taken into account in the weighting factor and
                        should thus be separately included in the final
                        calculations . The weighting factors are loosely based
                        on Maslow’s hierarchy of needs and similar theories.
                      </Trans>
                    </Typography>
                    <Typography variant="body1" paragraph>
                      <Trans i18nKey="learning.impact.sa.introduction.3">
                        Economic consequences are covered by the indicators Fa –
                        Asset losses and cost of coping and Fb – Reduction of
                          ...
                          <TableRow>
                            ...
                            <TableCell sx={{ width: "16.6%" }}>
                              <Trans i18nKey="learning.impact.sa.needs.2">
                                ...
                                care, telecommunications, transport, financial
                                services
                              </Trans>
                            </TableCell>
                            <TableCell sx={{ width: "16.6%" }}>
                  ...
                  <Box sx={{ mb: 8, ml: 3 }}>
                    <Typography variant="body1" paragraph>
                      <Trans i18nKey="learning.impact.sb.introduction.1">
                        ...
                        unrest, impinging upon or unduly restricting the daily
                        life of the general public. Such adverse effects are
                        measured in person days. The minimum duration per person
                        is one day.
                      </Trans>
                    </Typography>
                    <Typography variant="body1" paragraph>
                      <Trans i18nKey="learning.impact.sb.introduction.2">
                        ...
                        calculations should not include the amount of people
                        present at the demonstration or riots (the underlying
                        reasons for the demonstrations are captured by indicator
                        Sd – Loss of confidence in or functioning of the state
                        and/or its values) but the amount of people that are
                        afraid to go outside. Similarly in the aftermath of a
                        terrorist attack on a soft target it would capture the
                        amount of people with some form of PTSD (post-traumatic
                        stress disorder) who are afraid of venturing into open
                        public spaces.
                      </Trans>
                    </Typography>
                  ...
                  <Box sx={{ mb: 8, ml: 3 }}>
                    <Typography variant="body1" paragraph>
                      <Trans i18nKey="learning.impact.sc.introduction.1">
                        This indicator comprises the significance and duration
                        of a reputational loss for Belgium abroad. Damage to
                        Belgium’s reputation could, for example, lead to a
                        situation where other countries refuse to enter into
                        bilateral, multilateral and international agreements
                        with it, or where its status as a business/tourism
                        destination is severely compromised.
                      </Trans>
                    </Typography>
                    <Typography variant="body1" paragraph>
                      <Trans i18nKey="learning.impact.sc.introduction.2">
                        This indicator qualitatively takes into account the
                        significance of the reputational loss and its duration.
                      </Trans>
                    </Typography>
                    ...
                    <Typography variant="body1" paragraph>
                      <Trans i18nKey="learning.impact.sd.introduction.3">
                        ...
                        qualitative descriptions of indicator Sc and Sd should
                        not be interpreted as strong limits, but rather as peak
                        values of a distribution in time. E.g. for damage class
                        Sd2 it may be possible that some critical media coverage
                        still occurs months later, but the extent and frequency
                        should be much lower than during the first few weeks.
                  ...
                  <Box sx={{ mb: 8, ml: 3 }}>
                    <Typography variant="body1" paragraph>
                      <Trans i18nKey="learning.impact.sd.introduction.1">
                        ...
                        confidence in the state in general and its institutions
                        and the share of the population that is losing
                        confidence, as well as a loss of functioning of the
                        state. Such institutions may include the executive,
                        legislative, or legal branches of government as well as
                        state and regional organisations such as public
                        administrations, the armed forces, the police as well as
                    ...
                    <Typography variant="body1" paragraph>
                      <Trans i18nKey="learning.impact.sd.introduction.2">
                        ...
                        qualitatively and includes, for instance, the question
                        of whether the loss of confidence extends to individual
                        regional administrative units or to the federal
                        administration in general. It is assumed that a loss of
                        confidence is measurable by the amount of public
                        backlash.
                      </Trans>
                    </Typography>
              ...
              <Typography variant="body1" paragraph>
                <Trans i18nKey="learning.impact.e.introduction">
                  The indicator for the damage area ‘environment’ express the
                  effects of a hazard on the environment. The main effects
                  include water pollution, ground pollution, and changes to the
                  ...
                  <Box sx={{ mb: 8, ml: 3 }}>
                    <Typography variant="body1" paragraph>
                      <Trans i18nKey="learning.impact.ea.introduction.1">
                        Indicator Ea measures the size and the duration of an
                        adverse event on ecosystems (woodlands, agro ecosystems,
                        watercourses, lakes, wetlands etc.), which are seriously
                        damaged as a result and which will recover very slowly,
                        if ever. Effects may be caused, for instance, through
                        chemical or radiological pollution, through biological
                        or non-biological contamination, e.g. due to alien
                    ...
                    <Typography variant="body1" paragraph>
                      <Trans i18nKey="learning.impact.ea.introduction.2">
                        Impacts are understood as damage to ecosystems and/or
                    ...
                    <Typography variant="body1" paragraph>
                      <Trans i18nKey="learning.impact.ea.introduction.3">
                        ...
                        balance is upset considerably or the soil fertility is
                        significantly compromised. For example, heavy chemical
                        pollution of surface waters is measured with the
                        indicator Ea. If the water level of a lake significantly
                        drops as a result of drought, but without damaging the
                        flora and the fauna in the medium to long term, this is
                        not considered as an adverse impact on the ecosystem.
                      </Trans>
                    </Typography>
                    <Typography variant="body1" paragraph>
                      <Trans i18nKey="learning.impact.ea.introduction.4">
                        ...
                        indicators (e.g. their use for leisure and recreation).
                        If drought leads to restrictions on the supply of
                        drinking water from surface water among sections of the
                        population, this is recorded by the indicator Sa –
                        Supply shortfalls and disruptions. The economic impact
                        of ecosystem damage is not covered by the indicator Ea
                        but by the economic indicators Fa (Financial assest
                        damages) and Fb (Reduction of economic performance).
                      </Trans>
                    </Typography>
                    <Typography variant="body1" paragraph>
                      <Trans i18nKey="learning.impact.ea.introduction.5">
                        ...
                        affected area with the number of years that the adverse
                        effect lasts. If an area is under the influence of
                    ...
                    <Typography variant="body1" paragraph>
                      <Trans i18nKey="learning.impact.ea.introduction.6">
                        ...
                        during which the ecosystem persists or the restrictions
                        on its use (e.g. restrictions of cultivation on
                        agricultural land) remain in place. The cycle of
                        different stages of an ecosystem, e.g. succession stages
                        in managed forests, should be taken into account. An
                        ecosystem is regarded as damaged until its condition
                        returns to ‘normal’. For instance, in the case of a
                        forest damaged by an extensive fire, the duration is the
                        time until the re-establishment of the early succession
                        stages.
                      </Trans>
                    </Typography>
              ...
              <Typography variant="body1" paragraph>
                <Trans i18nKey="learning.impact.f.introduction">
                  Economic effects and damages are counted as financial asset
                  damages (Fa), and the reduction of economic performance (Fb).
                </Trans>
              </Typography>
                  ...
                  <Box sx={{ mb: 8, ml: 3 }}>
                    <Typography variant="body1" paragraph>
                      <Trans i18nKey="learning.impact.fa.introduction.1">
                        Damage indicator Fa measures losses to existing assets
                    ...
                    <Typography variant="body1" paragraph>
                      <Trans i18nKey="learning.impact.fa.introduction.4">
                        ...
                        buildings and a factory. This runs up costs for pumping
                        out basements and removing rubble and driftwood (cost of
                        coping). The physical damage leads to financial losses
                        as the value of the buildings and equipment is now
                        diminished.
                      </Trans>
                    </Typography>
                    <Typography variant="body1" paragraph>
                      ...
                      <li>
                        <Typography variant="body1" paragraph>
                          <Trans i18nKey="learning.impact.fa.introduction.6">
                            macroeconomic: nationwide cost of coping and damage
                            to national wealth.
                          </Trans>
                        </Typography>
                      </li>
                  ...
                  <Box sx={{ mb: 8, ml: 3 }}>
                    <Typography variant="body1" paragraph>
                      <Trans i18nKey="learning.impact.fb.introduction.1">
                        Damage indicator Fb includes indirect economic effects
                        that reduce value creation in Belgium. While Fa –
                        Financial losses and cost of coping relates to the cost
                        of coping and damage to existing assets, Fb takes into
                    ...
                    <Typography variant="body1" paragraph>
                      <Trans i18nKey="learning.impact.fb.introduction.2">
                        The example used to illustrate this indicator is
                        flooding (cf. example in Fa). Due to the damage caused
                        by such an event, the affected company has zero output
                        for several weeks and therefore suffers a loss of
                        income.
                      </Trans>
                    </Typography>
                    <Typography variant="body1" paragraph>
                      <Trans i18nKey="learning.impact.fb.introduction.3">
                        Depending on the effects of the hazard, various
                        perspectives can be adopted regarding financial losses:
                      </Trans>
                    </Typography>
                    <ul>
                      <li>
                        <Typography variant="body1" paragraph>
                          <Trans i18nKey="learning.impact.fb.introduction.4">
                            ...
                            used as an indicator of total economic performance.
                            It is quantified in terms of Gross Domestic Product
                            (GDP). Thus, a reduction of economic performance
                            corresponds to a decline in GDP.
                          </Trans>
                        </Typography>
                      </li>
                      <li>
                        <Typography variant="body1" paragraph>
                          <Trans i18nKey="learning.impact.fb.introduction.5">
                            ...
                            performance for individuals or within a spatially
                            limited unit.
                          </Trans>
                        </Typography>
                      </li>
                    ...
                    <Typography variant="body1" paragraph>
                      <Trans i18nKey="learning.impact.fb.introduction.6">
                        For this reason and for ease of evaluation for experts
                        without a financial background, multiple equivalent
                        interpretations of the damage classes are provided.
                      </Trans>
                    </Typography>
