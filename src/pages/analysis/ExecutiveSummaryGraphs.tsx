...
export default function ExecutiveSummaryGraph({
  ...
  const scenarioSuffix = getScenarioSuffix(scenario === "wcs" ? getWorstCaseScenario(calculation) : scenario);
