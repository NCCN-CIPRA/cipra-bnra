  ...
  const stepsTutorial: Step[] = [
      ...
      content: (
        <Box sx={{ textAlign: "left" }}>
          <Typography variant="body1" my={2}>
            <Trans i18nKey="2B.MM.tutorial.climateChange.1.1">
    ...
    },
    {
      ...
      content: (
        <Box sx={{ textAlign: "left" }}>
          <Typography variant="body1" my={2}>
            <Trans i18nKey="2B.MM.tutorial.climateChange.2.1">
    ...
    },
    {
      ...
      content: (
        <Box sx={{ textAlign: "left" }}>
          <Typography variant="body1" my={2}>
            <Trans i18nKey="2B.MM.tutorial.climateChange.21.1">
    ...
    },
    {
      ...
      content: (
        <Box sx={{ textAlign: "left" }}>
          <Typography variant="body1" my={2}>
            <Trans i18nKey="2B.MM.tutorial.climateChange.3.1">
    ...
    },
    {
      ...
      content: (
        <Box sx={{ textAlign: "left" }}>
          <Typography variant="body1" my={2}>
            <Trans i18nKey="2B.MM.tutorial.climateChange.4.1">
    ...
    },
    {
      ...
      content: (
        <Box sx={{ textAlign: "left" }}>
          <Typography variant="body1" my={2}>
            <Trans i18nKey="2B.MM.tutorial.climateChange.10.1">
