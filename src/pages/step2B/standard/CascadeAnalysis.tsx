...
export default function CascadeAnalysis({
  ...
  useEffect(() => {
    if (cascadeAnalysis && quantiErrors !== null) {
      ...
      if (cascadeAnalysis.cr4de_c2m === null) handleChangeScenario(SCENARIOS.CONSIDERABLE, SCENARIOS.MAJOR);
      if (cascadeAnalysis.cr4de_c2e === null) handleChangeScenario(SCENARIOS.CONSIDERABLE, SCENARIOS.EXTREME);
      if (cascadeAnalysis.cr4de_m2c === null) handleChangeScenario(SCENARIOS.MAJOR, SCENARIOS.CONSIDERABLE);
      if (cascadeAnalysis.cr4de_m2m === null) handleChangeScenario(SCENARIOS.MAJOR, SCENARIOS.MAJOR);
      if (cascadeAnalysis.cr4de_m2e === null) handleChangeScenario(SCENARIOS.MAJOR, SCENARIOS.EXTREME);
      if (cascadeAnalysis.cr4de_e2c === null) handleChangeScenario(SCENARIOS.EXTREME, SCENARIOS.CONSIDERABLE);
      if (cascadeAnalysis.cr4de_e2m === null) handleChangeScenario(SCENARIOS.EXTREME, SCENARIOS.MAJOR);
      if (cascadeAnalysis.cr4de_e2e === null) handleChangeScenario(SCENARIOS.EXTREME, SCENARIOS.EXTREME);
      window.scrollTo({
        behavior: "smooth",
              ...
              component: cascadeAnalysis && (
                <Stack direction="column" sx={{ position: "relative", pb: 12 }}>
                  ...
                  <Typography variant="h6" sx={{ mb: 4 }} id="cascade-title-text">
                    <Tooltip
                      title={t("2B.cause.openRiskFile", "Click to open the risk file for this risk in a new tab")}
                    >
                  ...
                  <Stack direction="column" sx={{ marginTop: 10 }}>
                    <Typography variant="body2" paragraph>
                      <Trans i18nKey="2B.causes.summary.1">
                        Dans le tableau ci-dessous, vous trouverez, pour chaque lien de cause à effet, un aperçu de
                        l’ensemble de vos évaluation quantitatives. Cet aperçu se met à jour automatiquement. Il vous
                        permet de vérifier la cohérence de vos évaluations.
                      </Trans>
                    </Typography>
                    <ul>
                      <li>
                        <Typography variant="body2" paragraph>
                          <Trans i18nKey="2B.causes.summary.2">
                            In de kolomen: Controleer of de opgegeven CPx waardes voor éénzelfde intensiteitsscenario
                            van het gevolgrisico (bv. grootschalig gevolgrisico) <b>gelijk blijven of toenemen</b> met
                            de toenemende intensiteit van het scenario van het oorzaakrisico (van boven naar beneden:
                            aanzienlijk --&gt; grootschalig --&gt; extreem oorzaakrisico).
                          </Trans>
                        </Typography>
                      </li>
                      <li>
                        <Typography variant="body2" paragraph>
                          <Trans i18nKey="2B.causes.summary.4">
                            In de rijen: Controleer of de opgegeven CPx waardes voor éénzelfde intensiteitsscenario van
                            het oorzaakrisico (bv. extreem oorzaakrisico) gelijk blijven of afnemen met de toenemende
                            intensiteit van het scenario van het gevolgrisico (van links naar rechts: aanzienlijk --&gt;
                            grootschalig --&gt; extreem gevolgrisico).
                          </Trans>
                        </Typography>
                      </li>
                    </ul>
                      ...
                      <CascadeMatrix
                        ...
                        onChangeScenario={(...opts) => {
                          ...
                          window.scrollTo({
                            ...
                            top:
                              window.scrollY +
                              (document.getElementById("cascade-title")?.getBoundingClientRect().top || 0),
                          });
                        }}
                      />
                    )}
                  ...
                  <Stack direction="column" sx={{ marginTop: 10 }}>
                    ...
                    <Typography variant="body2" paragraph>
                      <Trans i18nKey="2B.causes.quali.2">
                        Attention, ce champ doit être complété une seule fois pour chaque relation de cause à effet.
                        Vous pouvez ajouter des précisions concernant les 9 estimations de la probabilité conditionnelle
                        dans le même champ textuel.
                      </Trans>
                    </Typography>
                  </Stack>
