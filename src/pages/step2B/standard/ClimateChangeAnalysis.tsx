...
import { Box, Tooltip, CircularProgress, Paper, Container, Alert, Typography, Stack, Button } from "@mui/material";
...
export default function ClimateChangeAnalysis({
  ...
  const handleChange = (field: string) => async (newValue: string | null) => {
    ...
    step2AInput[field as keyof CCInput] = newValue;
  };

  if (!step2AInput) return <CircularProgress />;
          ...
          <Box sx={{ mb: 4 }} id="considerable-scenario">
            ...
            <Box component={Paper} sx={{ mt: 2, py: 2, px: 3, mb: 4 }} id="step2A-dp-quantitative-box">
              ...
              <DP50Slider
                ...
                initialDP50Value={step2AInput.cr4de_dp50_quanti_c}
          ...
          <Box sx={{ mb: 4 }} id="major-scenario">
            ...
            <Box component={Paper} sx={{ mt: 2, py: 2, px: 3, mb: 4 }} id="step2A-dp-quantitative-box">
              ...
              <DP50Slider
                ...
                initialDP50Value={step2AInput.cr4de_dp50_quanti_m}
          ...
          <Box sx={{}} id="extreme-scenario">
            ...
            <Box component={Paper} sx={{ mt: 2, py: 2, px: 3, mb: 4 }} id="step2A-dp-quantitative-box">
              ...
              <DP50Slider
                ...
                initialDP50Value={step2AInput.cr4de_dp50_quanti_e}
          ...
          <Box sx={{ marginTop: 2, marginBottom: 3 }}>
            <QualiTextInputBox
              ...
              onSave={(v) => {
                ...
                step2AInput.cr4de_dp50_quali = v || null;
              }}
              setUpdatedValue={(newValue) => {
                if (!step2AInput) return;

                step2AInput.cr4de_dp50_quali = newValue || null;
              }}
