...
export default function Standard({
  ...
  return (
    <>
      ...
      <Box sx={{ mx: 4 }}>
        <Box sx={{ mb: 8 }}>
          <ParameterSection directAnalysis={directAnalysis} parameter={PARAMETER.DP} />
          <ParameterSection directAnalysis={directAnalysis} parameter={PARAMETER.H} />
          <ParameterSection directAnalysis={directAnalysis} parameter={PARAMETER.S} />
          <ParameterSection directAnalysis={directAnalysis} parameter={PARAMETER.E} />
          <ParameterSection directAnalysis={directAnalysis} parameter={PARAMETER.F} />
          <ParameterSection directAnalysis={directAnalysis} parameter={PARAMETER.CB} />
        </Box>
        <Box sx={{ mb: 8 }}>
          {causes.map((ca) => (
            <CauseSection
    ...
    <Accordion expanded={open} TransitionProps={{ unmountOnExit: true }}>
      ...
      <AccordionDetails>
        <Stack direction="row" sx={{ width: "100%", justifyContent: "stretch" }}>
          <ScenarioSection directAnalysis={directAnalysis} parameter={parameter} scenario={SCENARIOS.CONSIDERABLE} />
          <ScenarioSection directAnalysis={directAnalysis} parameter={parameter} scenario={SCENARIOS.MAJOR} />
          <ScenarioSection directAnalysis={directAnalysis} parameter={parameter} scenario={SCENARIOS.EXTREME} />
        </Stack>
      </AccordionDetails>
    </Accordion>
  );
...
function EmergingSection({
  ...
  directAnalysis: DVDirectAnalysis<DVRiskFile>;
  cascadeAnalysis: DVCascadeAnalysis<DVRiskCascade<SmallRisk>>;
}) {
  const discussionRequired = Boolean(
    cascadeAnalysis.cr4de_cascade.cr4de_discussion_required &&
      cascadeAnalysis.cr4de_cascade.cr4de_discussion_required !== DiscussionRequired.NOT_NECESSARY
  ...
  return (
    <Accordion expanded={open} TransitionProps={{ unmountOnExit: true }}>
      ...
      <AccordionDetails>
        {cascadeAnalysis.cr4de_cascade.cr4de_cause_hazard.cr4de_title.indexOf("Climate") < 0 ? (
          <Stack direction="column" sx={{ width: "100%" }}>
            <Box sx={{ p: 4 }}>
              <Typography variant="subtitle2">Preliminary Consensus Results:</Typography>
              <Box
          ...
          <Stack direction="column" sx={{ width: "100%" }}>
            <Box sx={{ p: 4 }}>
              ...
              <Stack direction="column" sx={{ mt: 2 }}>
                <Stack direction="row">
                  <Typography variant="caption" sx={{ flex: 1 }}>
                    <i>M2050</i> Average - Considerable Scenario:
                  </Typography>
                  <Typography variant="caption">
                    <b>{directAnalysis.cr4de_risk_file.cr4de_climate_change_quanti_c}</b>
                  </Typography>
                </Stack>
                <Stack direction="row">
                  <Typography variant="caption" sx={{ flex: 1 }}>
                    <i>M2050</i> Average - Major Scenario:
                  </Typography>
                  <Typography variant="caption">
                    <b>{directAnalysis.cr4de_risk_file.cr4de_climate_change_quanti_m}</b>
                  </Typography>
                </Stack>
                <Stack direction="row">
                  <Typography variant="caption" sx={{ flex: 1 }}>
                    <i>M2050</i> Average - Extreme Scenario:
                  </Typography>
                  <Typography variant="caption">
                    <b>{directAnalysis.cr4de_risk_file.cr4de_climate_change_quanti_e}</b>
                  </Typography>
                </Stack>
              </Stack>
              ...
              <Box
                dangerouslySetInnerHTML={{
                  __html: directAnalysis.cr4de_dp50_quali || "",
                }}
                sx={{ mt: 1, mb: 2, ml: 1, pl: 1, borderLeft: "4px solid #eee" }}
              />
              ...
              <Stack direction="column" sx={{ mt: 2 }}>
                <Stack direction="row">
                  <Typography variant="caption" sx={{ flex: 1 }}>
                    <i>M2050</i> Input - Considerable Scenario:
                  </Typography>
                  <Typography variant="caption">
                    <b>{directAnalysis.cr4de_dp50_quanti_c}</b>
                  </Typography>
                </Stack>
                <Stack direction="row">
                  <Typography variant="caption" sx={{ flex: 1 }}>
                    <i>M2050</i> Input - Major Scenario:
                  </Typography>
                  <Typography variant="caption">
                    <b>{directAnalysis.cr4de_dp50_quanti_m}</b>
                  </Typography>
                </Stack>
                <Stack direction="row">
                  <Typography variant="caption" sx={{ flex: 1 }}>
                    <i>M2050</i> Input - Extreme Scenario:
                  </Typography>
                  <Typography variant="caption">
                    <b>{directAnalysis.cr4de_dp50_quanti_e}</b>
                  </Typography>
                </Stack>
              </Stack>
            </Box>
