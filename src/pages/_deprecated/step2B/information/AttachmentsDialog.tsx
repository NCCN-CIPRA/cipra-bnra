...
export default function AttachmentsDialog({
  ...
  return (
    <Dialog open={open} onClose={onClose} maxWidth="xl" fullWidth={!isSaving} sx={{ maxHeight: 500, width: "100%" }}>
            ...
            <Grid container spacing={4}>
              ...
              {!existingSource && (
                <>
                  ...
                  >
                    <DialogContentText>
                      <Trans i18nKey="source.dialog.helpText.uploadSource">upload a file from your computer,</Trans>
                    </DialogContentText>
                    <Button variant="outlined" startIcon={<UploadFileIcon />} onClick={handlePickFile} sx={{ mb: 4 }}>
