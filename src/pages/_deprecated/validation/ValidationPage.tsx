...
export default function ValidationPage() {
   ...
   */
  const { data: validation, reloadData: reloadValidation } = useRecord<
    DVValidation<DVRiskFile>
  >({
    ...
    onComplete: async (result) => {
      ...
      const processedRiskFile: ProcessedRiskFile = {
        ...
        historicalEvents: HE.unwrap(
          result.cr4de_RiskFile.cr4de_historical_events
        ),
      ...
      if (!attachments)
        getAttachments({
          query: `$filter=_cr4de_risk_file_value eq ${processedRiskFile.cr4de_riskfilesid}`,
        });
    },
  });
  ...
  const handleSaveFields = async (
    fields: Partial<{ [key in keyof DVValidation]: string | null }>
  ) => {
  ...
  const handleSaveField =
    (field: keyof DVValidation) => async (newValue: string | null) => {
      return handleSaveFields({ [field]: newValue });
    };

  const handleSetFieldUpdates = async (
    fields: Partial<{ [key in keyof DVValidation]: string | null }>
  ) => {
  ...
  usePageTitle(
    t("validation.pageTitle", "BNRA 2023 - 2026 Risk Identification")
  );
  useBreadcrumbs([
    { name: t("bnra.shortName"), url: "/" },
    {
      name: t("validation.breadcrumb", "Risk Identification"),
      url: "/overview",
    },
  ...
  return (
    <>
      <Container sx={{ pb: 8 }} id="risk-file-container">
        {riskFile?.cr4de_validations_processed && (
          <Alert severity="info" sx={{ mb: 4 }}>
            <AlertTitle>
              <Trans i18nKey="validation.closed.title">
                Identification Finished
              </Trans>
            </AlertTitle>
            <Typography variant="caption">
              <Trans i18nKey="validation.closed.body">
                The identification step has been closed for this risk file and
                you will no longer be able to change your feedback. If you have
                any additional comments, please contact{" "}
                    ...
                    <Box sx={{ textAlign: "left" }}>
                      <Typography variant="body1" my={2}>
                        <Trans i18nKey="validation.definition.info.1">
                          The base of each risk file is the definition. It
                          determines the scope of the risk under study and in
                          some cases it also specifies which elements fall
                          outside the scope. This section also specifies, if
                          relevant, the differences between the risk studied and
                          the other risks studied within the framework of this
            ...
            <Box p={2} my={8}>
                      ...
                      <Box sx={{ textAlign: "left" }}>
                        <Typography variant="body1" my={2}>
                          <Trans i18nKey="validation.historicalEvents.info.1.1">
                            De historische gebeurtenissen in de risicofiche zijn
                            voorbeelden van gebeurtenissen die zich in België of
                            in het buitenland hebben voorgedaan.
                          </Trans>
                        </Typography>
                        <Typography variant="body1" my={2}>
                          <Trans i18nKey="validation.historicalEvents.info.1.2">
                            Deze sectie is optioneel en beoogt evenmin volledig
                            te zijn, maar ze kan wel helpen bij de selectie van
                            relevante intensiteitsparameters.
                          </Trans>
                        </Typography>
                      </Box>
                    ),
                      ...
                      <Box sx={{ textAlign: "left" }}>
                        <Typography variant="body1" my={2}>
                          <Trans i18nKey="validation.historicalEvents.info.2.1">
                            We nodigen u uit om kennis te nemen van de
                            historische gebeurtenissen in de onlineapplicatie en
                            deze te verbeteren of aan te vullen met andere
                            relevante historische gebeurtenissen en/of feedback
                            te geven in het daartoe voorziene vak.
                          </Trans>
                        </Typography>
                        <Typography variant="body1" my={2}>
                          <Trans i18nKey="validation.historicalEvents.info.2.2">
                            Van specifiek belang zijn grootte-ordes van de
                            intensiteit en/of impact van de gebeurtenis.
                          </Trans>
                        </Typography>
                        <Typography variant="body1" my={2}>
                          <Trans i18nKey="validation.historicalEvents.info.2.3">
                            Indien u beschikt over referenties, kunnen deze
              ...
              <Typography variant="subtitle2" mt={8} mb={2} color="primary">
                <Trans i18nKey="riskFile.historicalEvents.feedback">
                  Please provide any comments or feedback on the historical
                  event examples of the hazard below:
                </Trans>
              </Typography>
              ...
              {validation &&
                validation.cr4de_historical_events_feedback_response && (
                  <>
                    <Typography
                      variant="subtitle2"
                      mt={4}
                    ...
                    >
                      <Trans i18nKey="validation.feedback.response">
                        Our analist has responded the following to your
                        feedback:
                      </Trans>
                    </Typography>
        ...
        {riskFile && riskFile.cr4de_risk_type === "Standard Risk" && (
          <Paper>
            <Box p={2} my={8}>
                      ...
                      <Box sx={{ textAlign: "left" }}>
                        <Typography variant="body1" my={2}>
                          <Trans i18nKey="validation.parameters.info.1.1">
                            Het beoordelen van een risico in termen van impact
                            en waarschijnlijkheid op basis van een definitie
                            alleen kan ingewikkeld zijn. Een risico kan zich
                            immers in verschillende mate van intensiteit
                            voordoen.
                          </Trans>
                        </Typography>
                        <Typography variant="body1" my={2}>
                          <Trans i18nKey="validation.parameters.info.1.2">
                            Om dit probleem op te vangen, wordt elk te
                            beoordelen risico gekarakteriseerd aan de hand van 3
                            intensiteitscenario's; een “<i>considerable</i>",
                            een “<i>major</i>" en een "<i>extreme</i>" scenario,
                            deze worden opgebouwd aan de hand van
                            risicospecifieke
                      ...
                      <Box sx={{ textAlign: "left" }}>
                        <Typography variant="body1" my={2}>
                          <Trans i18nKey="validation.parameters.info.2.1">
                            De <b>intensiteitsparameters</b> komen overeen met
                            factoren die de ontwikkeling en de gevolgen van het
                            risico beïnvloeden.
                          </Trans>
                        </Typography>
                        <Typography variant="body1" my={2}>
                          <Trans i18nKey="validation.parameters.info.2.2">
                            Elk risico wordt dus gekenmerkt door specifieke
                            parameters. Zo zijn de parameters die de risico's «{" "}
                            <i>fluvial flood</i> » en «{" "}
                            <i>nuclear plant incident</i> » kenmerken
                            verschillend, omdat zij specifiek zijn voor het te
                            beoordelen risico.
                          </Trans>
                        </Typography>
                      </Box>
                      ...
                      <Box sx={{ textAlign: "left" }}>
                        <Typography variant="body1" my={2}>
                          <Trans i18nKey="validation.parameters.info.3.1">
                            Bijvoorbeeld, het risico « nuclear plant incident »
                            wordt gekenmerkt door volgende specifieke
                            parameters; die de ontwikkeling en de gevolgen van
                            het risico beïnvloeden:
                          </Trans>
                        </Typography>
                        <ul>
                          <li>
                            <Typography variant="body1" my={2}>
                              <Trans i18nKey="validation.parameters.info.3.2">
                                <b>Type incident:</b> parameter die de aard van
                                het incident beschrijft
                              </Trans>
                            </Typography>
                          </li>
                          <li>
                            <Typography variant="body1" my={2}>
                              <Trans i18nKey="validation.parameters.info.3.3">
                                <b>Vrijgavetijd:</b> tijd tussen het incident en
                                het vrijkomen van nucleaire stoffen
                              </Trans>
                            </Typography>
                          </li>
                          <li>
                            <Typography variant="body1" my={2}>
                              <Trans i18nKey="validation.parameters.info.3.4">
                                <b>Meteorologische omstandigheden:</b>{" "}
                                beschrijft de meteorologische omstandigheden
                      ...
                      <Box sx={{ textAlign: "left" }}>
                        <Typography variant="body1" my={2}>
                          <Trans i18nKey="validation.parameters.info.4.1">
                            We nodigen u uit om de voorgestelde
                            intensiteitsparameters en hun omschrijving te
                            bestuderen en feedback te formuleren ten aanzien van
                            deze elementen.
                          </Trans>
                        </Typography>
                        <Typography variant="body1" my={2}>
                          <Trans i18nKey="validation.parameters.info.4.2">
                            Als u vindt dat er een specifieke parameter
                            ontbreekt om de intensiteitsscenario's te
                            karakteriseren, kan u dit aangeven in het daartoe
                            bestemde vak.
                          </Trans>
                        </Typography>
                      </Box>
              ...
              {validation &&
                validation.cr4de_intensity_parameters_feedback_response && (
                  <>
                    <Typography
                      variant="subtitle2"
                      mt={4}
                      ...
                      <Box sx={{ textAlign: "left" }}>
                        <Typography variant="body1" my={2}>
                          <Trans i18nKey="validation.scenarios.info.2.1">
                            Om een intensiteitsscenario te definiëren of vorm te
                            geven, wordt aan elk van de specifieke parameters
                            hierboven een waarde toegekend. De parameter “
                            <i>Vrijgavetijd</i>” kan bijvoorbeeld worden geschat
                            op 12 uur voor een “<i>considerable</i>” scenario, 9
                            uur voor een “<i>mayor</i>” scenario en tussen 2 en
                            4 uur voor een “<i>extreme</i>” scenario.
                          </Trans>
                        </Typography>
                        <Typography variant="body1" my={2}>
                          <Trans i18nKey="validation.scenarios.info.2.2">
                            Tijdens de volgende stappen van de
                            risicobeoordeling, net na deze identificatiestap,
                            dienen alle 3 risicoscenario’s apart van elkaar
                            beoordeeld te worden. Daarom is het tijdens deze
                            eerste stap belangrijk dat de 3
                            intensiteitsscenario's door alle deelnemende
                            experten, voor een specifiek risico, gevalideerd
                            worden.
                          </Trans>
                        </Typography>
                      </Box>
                      ...
                      <Box sx={{ textAlign: "left" }}>
                        <Typography variant="body1" my={2}>
                          <Trans i18nKey="validation.scenarios.info.3.1">
                            We nodigen u uit om de drie voorgestelde
                            intensiteitsscenario's voor uw risico te bestuderen
                            en eventuele feedback te formuleren in het daartoe
                            bestemde vak.
                          </Trans>
                        </Typography>
                      </Box>
            ...
            <Box p={2} my={8}>
                        ...
                        <Box sx={{ textAlign: "left" }}>
                          <Typography variant="body1" my={2}>
                            <Trans i18nKey="validation.capabilities.info.1.1">
                              La section concernant les capacités des acteurs
                              permet de distinguer trois scénarios d’intensité
                              pour les risques malveillants d’origine humaine en
                              regroupant les acteurs selon trois niveaux de
                              capacité.
                            </Trans>
                          </Typography>
                          <Typography variant="body1" my={2}>
                            <Trans i18nKey="validation.capabilities.info.1.2">
                              Plus précisément, les 3 scénarios d’intensité
                            ...
                            <li>
                              <Typography variant="body1" my={2}>
                                <Trans i18nKey="validation.capabilities.info.1.3">
                                  <b>Considérable:</b> regroupe les acteurs
                                  disposant de faibles capacités techniques et
                                  opérationnelles
                                </Trans>
                              </Typography>
                            </li>
                            <li>
                              <Typography variant="body1" my={2}>
                                <Trans i18nKey="validation.capabilities.info.1.4">
                                  <b>Majeur:</b> regroupe les acteurs disposant
                                  de capacités techniques ou opérationnelles
                                  élevées (mais pas les deux à la fois)
                                </Trans>
                              </Typography>
                            </li>
                            <li>
                              <Typography variant="body1" my={2}>
                                <Trans i18nKey="validation.capabilities.info.1.5">
                                  <b>Extrême:</b> regroupe les acteurs disposant
                                  de capacités techniques et opérationnelles
                                  élevées.
                                </Trans>
                              </Typography>
                            </li>
                        ...
                        <Box sx={{ textAlign: "left" }}>
                          <Typography variant="body1" my={2}>
                            <Trans i18nKey="validation.capabilities.info.2.1">
                              Lors de la seconde étape de notre étude
                              (évaluation des risques), les capacités des
                              acteurs seront utilisées pour évaluer les
                              motivations des acteurs.
                            </Trans>
                          </Typography>
                          <Typography variant="body1" my={2}>
                            <Trans i18nKey="validation.capabilities.info.2.2">
                              Pour que l’étape 2 puisse se dérouler dans les
                              meilleures conditions, il est donc primordial que
                              les scénarios d’intensité soient validés par
                              l’ensemble des experts lors de cette étape 1.
                            </Trans>
                          </Typography>
                        </Box>
                      ),
                        ...
                        <Box sx={{ textAlign: "left" }}>
                          <Typography variant="body1" my={2}>
                            <Trans i18nKey="validation.capabilities.info.3.1">
                              Nous vous invitons à consulter la préparation des
                              analystes CIPRA et à donner votre feedback.
                            </Trans>
                          </Typography>
                          <Typography variant="body1" my={2}>
                            <Trans i18nKey="validation.capabilities.info.3.2">
                              Nous sommes conscients que les informations
                              demandées peuvent être sensibles. Les informations
                              contenues dans ces fiches de risques sont
                          ...
                          <Typography variant="body1" my={2}>
                            <Trans i18nKey="validation.capabilities.info.3.3">
                              Toutefois, si des informations sont trop sensibles
                              que pour les introduire dans les fiches de
                              risques, nous vous invitons à utiliser des données
                              agrégées (ex : au lieu de citer une liste de pays
                              précis en tant qu’acteur, vous avez la possibilité
                              d’utiliser une dénomination générique du type «
                              acteurs étatiques hostiles »).
                            </Trans>
                          </Typography>
                        </Box>
                      ),
              ...
              <Box mt={1}>
                <Alert severity="warning" sx={{ mb: 4 }}>
                  <AlertTitle>
                    <Trans i18nKey="actorCapabilities.attention.title">
                      Attention
                    </Trans>
                  </AlertTitle>
                  <Typography variant="caption">
              ...
              {riskFile ? (
                <Box>
                  ...
                  <Box
                    dangerouslySetInnerHTML={{
                      __html:
                        riskFile.scenarios.considerable &&
                        riskFile.scenarios.considerable[0]
                  ...
                  <Box
                    dangerouslySetInnerHTML={{
                      __html:
                        riskFile.scenarios.extreme &&
                        riskFile.scenarios.extreme[0]
            ...
            <Box p={2} my={8}>
                      ...
                      <Box sx={{ textAlign: "left" }}>
                        <Typography variant="body1" my={2}>
                          <Trans i18nKey="validation.horizon.info.1.1">
                            Pour rappel, au sein de notre étude, un risque
                            émergent est un risque qui, à l’heure actuelle, ne
                            constitue pas de menace en lui-même mais qui, s’il
                            se développe dans le futur, peut influencer les
                            autres risques analysés dans la BNRA 2023-2026.
                          </Trans>
                        </Typography>
                        <Typography variant="body1" my={2}>
                          <Trans i18nKey="validation.horizon.info.1.2">
                            L'analyse de l'horizon étudie et tente de prédire à
                            quelle vitesse le risque émergent peut se
                            manifester.
                          </Trans>
                        </Typography>
                        <Typography variant="body1" my={2}>
                          <Trans i18nKey="validation.horizon.info.1.3">
                            Cette section comprend donc une description
                            qualitative (ou quantitative lorsque, cela est
                            possible) d’une ou plusieurs trajectoires
                            d'évolution possibles du risque émergent y compris
                            les délais potentiels ou les événements
                            déclencheurs.
                          </Trans>
                        </Typography>
                      </Box>
                      ...
                      <Box sx={{ textAlign: "left" }}>
                        <Typography variant="body1" my={2}>
                          <Trans i18nKey="validation.horizon.info.2.1">
                            Prenons un exemple concret : pour le risque émergent
                            relatif au changement climatique, l’analyse
                            d’horizon comprendra par exemple une description
                            quantitative de différents scénarios basés sur les
                            trajectoires d'émission de GES. Pour une nouvelle
                            technologie, cette section comprendra par exemple
                            une description qualitative des courbes d'adoption
                            de la nouvelle technologie en question.
                          </Trans>
                        </Typography>
                        <Typography variant="body1" my={2}>
              ...
              <Typography variant="subtitle2" mt={8} mb={2} color="primary">
                <Trans i18nKey="riskFile.horizonAnalysis.feedback">
                  Please provide any comments or feedback on the horizon
                  analysis of the emerging risk below:
                </Trans>
              </Typography>
            ...
            <Box p={2} my={8}>
                      ...
                      <Box sx={{ textAlign: "left" }}>
                        <Typography variant="body1" my={2}>
                          <Trans i18nKey="validation.causes.info.1.1">
                            Deze en de volgende sectie van de risicofiche
                            behandelen de identificatie van de risico cascade of
                            met andere woorden identificeren de oorzaken en
                            gevolgen voor het bestudeerde risico.
                          </Trans>
                        </Typography>
                        <Typography variant="body1" my={2}>
                          <Trans i18nKey="validation.causes.info.1.2">
                            In deze sectie identificeren we specifiek andere
                            risico's uit de catalogus die aan de oorsprong van
                            het bestudeerde risico's kunnen liggen, dit wil
                            zeggen de oorzaken van het bestudeerde risico.
                          </Trans>
                        </Typography>
                      </Box>
                    ),
                      ...
                      <Box sx={{ textAlign: "left" }}>
                        <Typography variant="body1" my={2}>
                          <Trans i18nKey="validation.causes.info.2.1">
                            Ter herinnering, in de 2de stap, de stap van de
                            risicobeoordeling, zal u onder andere worden
                            gevraagd om de waarschijnlijkheid van elk
                            intensiteitsscenario in te schatten. In onze analyse
                            bestaat deze inschatting uit twee verschillende
                            elementen:
                          </Trans>
                        </Typography>
                        <ul>
                          <li>
                            <Typography variant="body1" my={2}>
                              <Trans i18nKey="validation.causes.info.2.2">
                                De directe waarschijnlijkheid (de
                                waarschijnlijkheid van optreden van ons risico
                                dat niet kan worden toegeschreven aan het zich
                                voordoen van een ander risico)
                              </Trans>
                            </Typography>
                          </li>
                          <li>
                            <Typography variant="body1" my={2}>
                              <Trans i18nKey="validation.causes.info.2.3">
                                De voorwaardelijke/ conditionele of indirecte
                                waarschijnlijkheid (de waarschijnlijkheid dat
                                ons risico optreedt net wel ten gevolge van het
                                zich voordoen van een ander risico).
                              </Trans>
                            </Typography>
                          </li>
                        </ul>
                        <Typography variant="body1" my={2}>
                          <Trans i18nKey="validation.causes.info.2.1">
                            Om de conditionele waarschijnlijkheden te kunnen
                            berekenen, moeten van te voren de linken tussen de
                            risico's worden bepaald of moeten met andere woorden
                            de cascades van elk te beoordelen risico uit de
                            BNRA23-26 volledig in kaart gebracht worden.
                          </Trans>
                        </Typography>
                        <Typography variant="body1" my={2}>
                          <Trans i18nKey="validation.causes.info.2.2">
                            Gelet op het belang ervan in de volgende stap, is
                            het essentieel dat de potentiële oorzaken voor een
                            specifiek risico in deze 1ste stap door alle
                            deelnemende experten gevalideerd worden.
                          </Trans>
                        </Typography>
                      </Box>
                    ),
                      ...
                      <Box sx={{ textAlign: "left" }}>
                        <Typography variant="body1" my={2}>
                          <Trans i18nKey="validation.causes.info.3.1">
                            <b>OPGELET!</b> In onze BNRA23-26 beschouwen wij een
                            risico alleen als zijnde een oorzaak als en slechts
                            als het een DIRECTE oorzaak is van het onderzochte
                            risico.
                          </Trans>
                        </Typography>
                        <Typography variant="body1" my={2}>
                          <Trans i18nKey="validation.causes.info.3.2">
                            Laat ons een concreet voorbeeld uitwerken: één van
                            de te beoordelen risico's uit de BNRA23-26 is het
                            risico “fluvial (riverine) flood” - overstroming
                            door het buiten de oevers treden van rivieren.
                          </Trans>
                        </Typography>
                        <Typography variant="body1" my={2}>
                          <Trans i18nKey="validation.causes.info.3.3">
                            Wij beschouwen het scenario « riverbank erosion »
                            echter niet als een DIRECTE oorzaak voor het risico
                            “fluvial (riverine) flood”. «Riverbank erosion» kan
                            indirect wel overstromingen veroorzaken door een
                            dijk te destabiliseren en een dijkdoorbraak te
                            veroorzaken. In onze beoordeling wordt het risico «
                            riverbank erosion » dus beschouwd als een DIRECTE
                            oorzaak van het risico « dike failure », dat op zijn
                            beurt wel wordt beschouwd als een DIREKTE oorzaak
                      ...
                      <Box sx={{ textAlign: "left" }}>
                        <Typography variant="body1" my={2}>
                          <Trans i18nKey="validation.causes.info.4.1">
                            We nodigen u uit om de voorgestelde oorzaken voor uw
                            risico, en indien beschikbaar, de redenen waarom een
                            link is vastgesteld tussen twee risico's te
                            bestuderen en uw feedback te formuleren ten aanzien
                            van deze elementen.
                          </Trans>
                        </Typography>
                        <Typography variant="body1" my={2}>
                          <Trans i18nKey="validation.causes.info.4.2">
                            Wenst u aanpassingen aan te brengen, met name, wenst
                            u een toevoeging of schrapping van een risico uit de
                            lijst van te evalueren risico's van de BNRA
                            2023-2026 voor te stellen, geef dit dan ook aan in
                            het daartoe voorziene tekst vak in de onlinetool.
                            Desgevallend is het wel wenselijk om kort toe te
                            lichten waarom een risico al dan niet als een
                            DIRECTE oorzaak van het bestudeerde risico moet
                            worden beschouwd.
                          </Trans>
                        </Typography>
                      </Box>
              ...
              <Box mt={1}>
                <Alert severity="warning">
                  <AlertTitle>
                    <Trans i18nKey="transferList.attention.title">
                      Attention!
                    </Trans>
                  </AlertTitle>
                  <Typography variant="caption">
                    <Trans i18nKey="transferList.attention">
                      You are not able to directly move the the risks between
                      the lists. Please describe your proposed changes in the
                      input field below
                    </Trans>
                  </Typography>
                </Alert>
            ...
            <Box p={2} my={8}>
                      ...
                      <Box sx={{ textAlign: "left" }}>
                        <Typography variant="body1" my={2}>
                          <Trans i18nKey="validation.actions.info.1.1">
                            Les actions malveillantes correspondent aux risques
                            de la BNRA-2023-2026 qui peuvent être provoqués par
                            les groupes d’acteurs identifiés dans une fiche de
                            type man made.
                          </Trans>
                        </Typography>
                      </Box>
                      ...
                      <Box sx={{ textAlign: "left" }}>
                        <Typography variant="body1" my={2}>
                          <Trans i18nKey="validation.actions.info.3.1">
                            Nous vous invitons à consulter la proposition des
                            analystes CIPRA et à donner votre feedback.
                          </Trans>
                        </Typography>
                        <Typography variant="body1" my={2}>
                          <Trans i18nKey="validation.actions.info.3.2">
                            Si, selon vous, il serait pertinent d’ajouter ou de
                            supprimer une action malveillante à la liste
                            proposée, signalez-le également via l’outil en
                            ligne, en expliquant brièvement pourquoi cette
                            action malveillante doit ou non être considérée
                            comme dans le cadre de votre fiche de risques.
                          </Trans>
                        </Typography>
                      </Box>
                    ),
              ...
              <Typography variant="subtitle2" mt={8} mb={2} color="primary">
                <Trans i18nKey="riskFile.maliciousActions.feedback">
                  Please provide any comments or feedback on the list of
                  potential actions of these actors below:
                </Trans>
              </Typography>
                      ...
                      <Box sx={{ textAlign: "left" }}>
                        <Typography variant="body1" my={2}>
                          <Trans i18nKey="validation.effects.info.1.1">
                            Deze en de vorige sectie van de risicofiche
                            behandelen de identificatie van de risico cascade of
                            met andere woorden identificeren de oorzaken en
                            gevolgen voor het bestudeerde risico.
                          </Trans>
                        ...
                        <Typography variant="body1" my={2}>
                          <Trans i18nKey="validation.effects.info.1.2">
                            In deze sectie identificeren we specifiek andere
                            risico's uit de catalogus die een mogelijk gevolg
                            van het bestudeerde risico's kunnen zijn.
                          </Trans>
                        </Typography>
                      </Box>
                    ),
                      ...
                      <Box sx={{ textAlign: "left" }}>
                        ...
                        <Typography variant="body1" my={2}>
                          <Trans i18nKey="validation.effects.info.2.5">
                            Gelet op het belang ervan in de volgende stap, is
                            het essentieel dat de potentiële gevolgen voor een
                            specifiek risico in deze 1ste stap door alle
                            deelnemende experten gevalideerd worden.
                          </Trans>
                        </Typography>
                      ...
                      <Box sx={{ textAlign: "left" }}>
                        <Typography variant="body1" my={2}>
                          <Trans i18nKey="validation.effects.info.3.1">
                            <b>OPGELET!</b> In onze BNRA23-26 beschouwen wij een
                            risico alleen als zijnde een gevolg als en slechts
                            als het een DIRECTE gevolg is van het onderzochte
                            risico.
                          </Trans>
                        </Typography>
                        <Typography variant="body1" my={2}>
                          <Trans i18nKey="validation.effects.info.3.2">
                            Laat ons een concreet voorbeeld uitwerken: één van
                            de te beoordelen risico's uit de BNRA23-26 is het
                            risico “attack against a CBRN-e infrastructure” -
                            een aanval tegen een infrastructuur waar risicolijke
                            stoffen verwerkt worden.
                          </Trans>
                        </Typography>
                        <Typography variant="body1" my={2}>
                          <Trans i18nKey="validation.effects.info.3.3">
                            Wij beschouwen het scenario « release of chemical
                            agents » echter niet als een DIRECTE gevolg voor het
                            risico “attack against a CBRN-e infrastructure”. «
                            release of chemical agents » kan wel indirect volgen
                            uit het risico « incident in a CBRN-e infrastructure
                            », dat op zijn beurt wel wordt beschouwd als een
                            DIRECT gevolg van het risico “attack against a
                      ...
                      <Box sx={{ textAlign: "left" }}>
                        <Typography variant="body1" my={2}>
                          <Trans i18nKey="validation.effects.info.4.1">
                            We nodigen u uit om de voorgestelde gevolgen voor uw
                            risico, en indien beschikbaar, de redenen waarom een
                            link is vastgesteld tussen twee risico's te
                            bestuderen en uw feedback te formuleren ten aanzien
                            van deze elementen.
                        ...
                        <Typography variant="body1" my={2}>
                          <Trans i18nKey="validation.effects.info.4.2">
                            ...
                            het daartoe voorziene tekst vak in de onlinetool.
                            Desgevallend is het wel wenselijk om kort toe te
                            lichten waarom een risico al dan niet als een DIRECT
                            gevolg van het bestudeerde risico moet worden
                            beschouwd.
                          </Trans>
                        </Typography>
                      </Box>
                      ...
                      <Box sx={{ textAlign: "left" }}>
                        <Typography variant="body1" my={2}>
                          <Trans i18nKey="validation.catalysedEffects.info.1.1">
                            Een opkomend risico oefent een katalyserend effect
                            uit op een ander gevaar, indien het in de toekomst,
                            een effect kan hebben op de gevolgen of de
                            waarschijnlijkheid van het optreden van het gevaar
                            in kwestie.
                          </Trans>
                        </Typography>
                        <Typography variant="body1" my={2}>
                          <Trans i18nKey="validation.catalysedEffects.info.1.2">
                            Les analystes CIPRA ont, au sein de chaque fiche de
                            risque, réalisé une première identification des des
                            dangers qui peuvent être catalysées par le risque
                      ...
                      <Box sx={{ textAlign: "left" }}>
                        <Typography variant="body1" my={2}>
                          <Trans i18nKey="validation.catalysedEffects.info.2.1">
                            Nous vous invitons à consulter la proposition
                            réalisée par les analystes CIPRA et à donner votre
                            feedback sur ces différents éléments.
                          </Trans>
                        </Typography>
                        <Typography variant="body1" my={2}>
                          <Trans i18nKey="validation.catalysedEffects.info.2.2">
                            En cas de modification, veuillez expliquer
                            brièvement pourquoi un risque émergent doit ou non
                            être considéré comme ayant un effet catalyseur sur
                            un autre danger.
                          </Trans>
                        </Typography>
                      </Box>
            ...
            <Box p={2} my={8}>
                      ...
                      <Box sx={{ textAlign: "left" }}>
                        <Typography variant="body1" my={2}>
                          <Trans i18nKey="validation.catalysing.info.1.1">
                            Deze sectie van de risicofiche identificeert uit
                            opkomende risico’s die de impacten en of de
                            waarschijnlijkheden van het bestudeerde risico
                            beïnvloed of "katalyseert".
                          </Trans>
                        </Typography>
                      </Box>
                    ),
                      ...
                      <Box sx={{ textAlign: "left" }}>
                        <Typography variant="body1" my={2}>
                          <Trans i18nKey="validation.catalysing.info.2.1">
                            In onze studie wordt een opkomend risico
                            gedefinieerd als elk proces dat nieuwe combinaties
                            van risico's kan creëren of bestaande risico's kan
                            wijzigen.
                          </Trans>
                        </Typography>
                        <Typography variant="body1" my={2}>
                          <Trans i18nKey="validation.catalysing.info.2.2">
                            Dit zijn risico's die momenteel op zichzelf geen
                            risico vormen, maar die, als zij zich ontwikkelen,
                            van invloed kunnen zijn op de andere risico's die
                            geanalyseerd worden binnen de BNRA 2023-2026.
                          </Trans>
                        </Typography>
                      </Box>
                    ),
                      ...
                      <Box sx={{ textAlign: "left" }}>
                        ...
                        <Typography variant="body1" my={2}>
                          <Trans i18nKey="validation.catalysing.info.3.2">
                            «Quantum computing» is momenteel geen technologie
                            die op grote schaal in onze samenleving wordt
                            gebruikt. De opkomst/uitrol ervan in de toekomst zou
                            echter de waarschijnlijkheid van optreden van het
                            risico «Cyber attack against a government
                            institution» kunnen vergroten.
                          </Trans>
                        </Typography>
                        <Typography variant="body1" my={2}>
                          <Trans i18nKey="validation.catalysing.info.3.3">
                            Een opkomend risico oefent een katalyserend effect
                            uit op het bestudeerde risico indien het, in de
                            toekomst, een effect kan hebben op de “gevolgen /
                            impacten” of de “waarschijnlijkheid van optreden”
                            van het bestudeerde risico.
                          </Trans>
                        </Typography>
                      </Box>
                    ),
                  ...
                  },
                  {
                    ...
                    content: (
                      <Box sx={{ textAlign: "left" }}>
                        <Typography variant="body1" my={2}>
                          <Trans i18nKey="validation.effects.info.4.1">
                            We nodigen u uit om de voorgestelde geïdentificeerde
                            opkomende risico’s en indien beschikbaar, de redenen
                            waarom dit opkomende risico een katalyserend effect
                            heeft op het bestudeerde risico, te bestuderen en uw
                            feedback te formuleren ten aanzien van deze
                            elementen.
                          </Trans>
                        </Typography>
                        <Typography variant="body1" my={2}>
                          <Trans i18nKey="validation.effects.info.4.2">
                            Wenst u aanpassingen aan te brengen, met name, wenst
                            u een opkomend risico uit de selectie te schrappen
                            of een opkomend risico uit de lijst van beschikbare
                            opkomende risico’s van de BNRA 2023-2026 toe te
                            voegen, geef dit dan ook aan in het daartoe
                            voorziene tekst vak in de onlinetool. Desgevallend
                            is het wel wenselijk om kort toe te lichten waarom
                            een opkomend risico al dan niet een katalyserend
                            effect uitoefent op het bestudeerde risico.
                          </Trans>
                        </Typography>
                      </Box>
                    ),
              ...
              <Typography variant="subtitle2" mt={8} mb={2} color="primary">
                <Trans i18nKey="riskFile.catalysingEffects.feedback">
                  Please provide any comments or feedback on the catalysing
                  effects of the hazard below:
                </Trans>
              </Typography>
              ...
              {validation &&
                validation.cr4de_catalysing_effects_feedback_response && (
                  <>
                    <Typography
                      variant="subtitle2"
                      mt={4}
      ...
      >
        <DialogTitle>
          <Trans i18nKey="validation.dialog.title">
            Are you finished validating this risk file?
          </Trans>
        </DialogTitle>
        <DialogContent>
          <DialogContentText>
            <Trans i18nKey="validation.dialog.helpText">
              Even if you indicate that you are finished, you can still return
              at a later time to make changes until the end of the validation
              phase.
            </Trans>
          </DialogContentText>
        </DialogContent>
        <DialogActions>
          ...
          >
            <Trans i18nKey="validation.dialog.cancel">
            ...
            onClick={async () => {
              ...
              if (participants.length >= 0) {
                api.updateParticipant(
                  participants[0].cr4de_bnraparticipationid,
                  {
