            ...
            <Table>
              ...
              <TableBody>
                ...
                <TableRow>
                  ...
                  <TableCell>
                    <Trans i18nKey="learning.probability.q.1">Very unlikely; Few, if any, known events worldwide</Trans>
                  </TableCell>
                </TableRow>
              </TableBody>
            </Table>
        ...
        <Box sx={{ py: 4, textAlign: "justify" }}>
          ...
          <Typography variant="body1" paragraph>
            <Trans i18nKey="learning.impact.h.introduction">
              ...
              integrity and mental health (Hb) of the general public. Hc captures those individuals requiring assistance
          ...
          <Typography variant="body1" paragraph>
            <Trans i18nKey="learning.impact.hb.introduction.3">
              ...
              suffering from psychological trauma (e.g. post-traumatic stress disorder) resulting in impingement upon or
              unduly restricting their daily life are covered by indicator Sb - Diminished public order and domestic
              security.
            </Trans>
          </Typography>
