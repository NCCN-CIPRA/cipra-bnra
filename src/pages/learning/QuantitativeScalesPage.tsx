...
export default function QuantitativeScalesPage({}) {
  ...
  useBreadcrumbs([
    ...
    { name: t("learning.general.scales.breadcrumb", "Quantitative Scales"), url: "/learning/quantitative-categories" },
  ]);
                ...
                <Box sx={{ mb: 8 }}>
                  ...
                  <Typography variant="body1" paragraph>
                    <Trans i18nKey="learning.impact.h.introduction">
                      The indicators for the human impact scale record the effects of a hazard on the lives (Ha),
                      physical integrity and mental health (Hb) of the general public. Hc captures those individuals
                      requiring assistance as a result of the event.
                    </Trans>
                  </Typography>
                  ...
                  <Box sx={{ height: collapsed.ha ? "auto" : 0 }}>
                    <Grow in={collapsed.ha} style={{ transformOrigin: "0 0 0" }}>
                      <Box sx={{ mb: 8, ml: 3 }}>
                        <Typography variant="body1" paragraph>
                          <Trans i18nKey="learning.impact.ha.introduction">
                            The damage indicator Ha relates to all people whose deaths can be directly attributed to the
                            event.
                          </Trans>
                        </Typography>
                            ...
                            <TableFooter>
                              <TableRow>
                                <TableCell colSpan={10}>
                                  <Trans i18nKey="learning.impact.ha.footer">Units: number of people deceased</Trans>
                                </TableCell>
                              </TableRow>
                            </TableFooter>
                          </Table>
                  ...
                  <Box sx={{ height: collapsed.hb ? "auto" : 0 }}>
                    <Grow in={collapsed.hb} style={{ transformOrigin: "0 0 0" }}>
                      <Box sx={{ mb: 8, ml: 3 }}>
                        <Typography variant="body1" paragraph>
                          <Trans i18nKey="learning.impact.hb.introduction.1">
                            The Hb indicator includes the number of people affected by injuries or diseases that can be
                            directly attributed to the event. The indicator takes into account physical and mental
                            illnesses or injuries connected to the hazard.
                          </Trans>
                        </Typography>
                        <Typography variant="body1" paragraph>
                          <Trans i18nKey="learning.impact.hb.introduction.2">
                            The basic units for this indicator are all people who suffer an injury, illness (incl. due
                            to endocrine disruption) as a result of the event. The three levels of severity outlined
                            below should be assessed accordingly. Differing degrees of injury severity are aggregated
                            using weighting factors.
                          </Trans>
                        </Typography>
                        <Typography variant="body1" paragraph>
                          <Trans i18nKey="learning.impact.hb.introduction.3">
                            Individuals who succumb to their injuries or illness are counted not under this indicator,
                            but under Ha – Fatalities. Individuals requiring one-time emergency psychological care but
                            who do not suffer from an underlying psychological illness are covered by indicator Hc –
                            People in need of assistance. Individuals suffering from psychological trauma (e.g.
                            post-traumatic stress disorder) resulting in impingement upon or unduly restricting their
                            daily life are covered by indicator Sb - Diminished public order and domestic security.
                          </Trans>
                        </Typography>
                        ...
                        <TableContainer component={Paper} sx={{ mb: 6 }}>
                          <Table>
                            ...
                            <TableFooter>
                              <TableRow>
                                <TableCell colSpan={10}>
                                  <Trans i18nKey="learning.impact.hb.footer">Unit: number of sick/injured people</Trans>
                                </TableCell>
                              </TableRow>
                            </TableFooter>
                          </Table>
                              ...
                              <TableRow>
                                <TableCell colSpan={10}>
                                  <Trans i18nKey="learning.impact.hb.level.footer">
                                    Injury and illness weighted according to their degree of severity
                                  </Trans>
                                </TableCell>
                              </TableRow>
                            </TableFooter>
                  ...
                  <Box sx={{ height: collapsed.hc ? "auto" : 0 }}>
                    <Grow in={collapsed.hc} style={{ transformOrigin: "0 0 0" }}>
                      <Box sx={{ mb: 8, ml: 3 }}>
                        <Typography variant="body1" paragraph>
                          <Trans i18nKey="learning.impact.hc.introduction.1">
                            Indicator Hc covers people who must be evacuated, temporarily housed, and/or otherwise cared
                            for before, during, and after an event. This may involve, for instance, housing in emergency
                            shelters; supplying food to people in locations cut off from the outside world; or giving
                            emergency psychological assistance to people who are not, however, affected by actual mental
                            illnesses. The duration of assistance required by the directly affected persons is
                            registered. Effects such as supply shortfalls and disruptions for large parts of the
                            population are counted not under Hc, but under the indicator Sa – Supply shortfalls and
                            service disruptions.
                          </Trans>
                        </Typography>
                        <Typography variant="body1" paragraph>
                          <Trans i18nKey="learning.impact.hc.introduction.2">
                            The unit to quantify the need for assistance is the person day. This is determined by
                            multiplying the number of people requiring assistance with the duration of impairment in
                            days . The effective duration of assistance required by all individuals is added up. The
                            minimum unit per person is one day. The duration of the requirement for assistance is
                            counted, rather than the period in which assistance services are provided. For instance, one
                            would count the number of days during which the total number of traumatised individuals
                            require emergency psychological assistance, rather than the duration for which the members
                            of care-providing organisations have been deployed.
                          </Trans>
                        </Typography>
                        <Typography variant="body1" paragraph>
                          <Trans i18nKey="learning.impact.hc.introduction.3">
                            The cost of providing support services is accounted for in the indicator Fa – Financial
                            asset damages.
                          </Trans>
                        </Typography>
                  ...
                  <Typography variant="body1" paragraph>
                    <Trans i18nKey="learning.impact.s.introduction">
                      ...
                      investigation. On the one hand, these may include the effects on the Belgian population, e.g.
                      through supply shortfalls and disruptions (Sa) or diminished public order and domestic security
                      (Sb). On the other hand, it captures the effects on the state: damage to the reputation of Belgium
                      abroad (Sc) and a loss of confidence in or functioning of the state and/or its values (Sd).
                    </Trans>
                  </Typography>
                  ...
                  <Box sx={{ height: collapsed.sa ? "auto" : 0 }}>
                    <Grow in={collapsed.sa} style={{ transformOrigin: "0 0 0" }}>
                      <Box sx={{ mb: 8, ml: 3 }}>
                        <Typography variant="body1" paragraph>
                          <Trans i18nKey="learning.impact.sa.introduction.1">
                            This indicator measures breakdowns or severe disruptions to the supply of critical goods and
                            services to the entire population or parts of it. They are grouped into three sets according
                            to their importance.
                          </Trans>
                        </Typography>
                        <Typography variant="body1" paragraph>
                          <Trans i18nKey="learning.impact.sa.introduction.2">
                            Supply shortfalls are calculated by multiplying the number of persons affected with the
                            duration (in days) for which their needs are not met. The effective duration of the
                            disruption for those affected is added together. Additionally, a distinction should be made
                            between needs of varying importance. The human need for water and food is obviously more
                            immediately important than the need for postal and courier services. Physical needs are to
                            be fulfilled if the individual is to survive, whereas the next categories rather ensure the
                            security and comfort needs. To model this fact, a weighting factor is given to each need
                            which should be applied in the final calculations. Notice that there may exist some
                            cascading effects between unmet needs, i.e. if the need for electricity is not met, usually
                            the need for telecommunication will also not be met. This effect is not taken into account
                            in the weighting factor and should thus be separately included in the final calculations .
                            The weighting factors are loosely based on Maslow’s hierarchy of needs and similar theories.
                          </Trans>
                        </Typography>
                        <Typography variant="body1" paragraph>
                          <Trans i18nKey="learning.impact.sa.introduction.3">
                            Economic consequences are covered by the indicators Fa – Asset losses and cost of coping and
                              ...
                              <TableRow>
                                <TableCell colSpan={10}>
                                  <Trans i18nKey="learning.impact.sa.footer">
                                    Unit: person days (number of people multiplied by days of unmet needs)
                                  </Trans>
                                </TableCell>
                              </TableRow>
                            </TableFooter>
                              ...
                              <TableRow>
                                ...
                                <TableCell sx={{ width: "16.6%" }}>
                                  <Trans i18nKey="learning.impact.sa.needs.1">
                                    Potable water, basic foodstuffs, medicine, medical emergency services, first
                              ...
                              <TableRow>
                                ...
                                <TableCell sx={{ width: "16.6%" }}>
                                  <Trans i18nKey="learning.impact.sa.needs.2">
                                    Electricity, heating, non-emergency medical care, telecommunications, transport,
                                    financial services
                                  </Trans>
                                </TableCell>
                                <TableCell sx={{ width: "16.6%" }}>
                  ...
                  <Typography variant="h6" paragraph>
                    ...
                    <Trans i18nKey="learning.impact.sb.title">Sb - Diminished public order and domestic security</Trans>
                  </Typography>
                  <Box sx={{ height: collapsed.sb ? "auto" : 0 }}>
                    <Grow in={collapsed.sb} style={{ transformOrigin: "0 0 0" }}>
                      <Box sx={{ mb: 8, ml: 3 }}>
                        <Typography variant="body1" paragraph>
                          <Trans i18nKey="learning.impact.sb.introduction.1">
                            This indicator measures how many people living in Belgium have experienced diminished public
                            order and domestic security, and for how long. This refers to adverse effects from domestic
                            disturbances, such as unrest, impinging upon or unduly restricting the daily life of the
                            general public. Such adverse effects are measured in person days. The minimum duration per
                            person is one day.
                          </Trans>
                        </Typography>
                        <Typography variant="body1" paragraph>
                          <Trans i18nKey="learning.impact.sb.introduction.2">
                            Thus when a large demonstration with riots happen, the calculations should not include the
                            amount of people present at the demonstration or riots (the underlying reasons for the
                            demonstrations are captured by indicator Sd – Loss of confidence in or functioning of the
                            state and/or its values) but the amount of people that are afraid to go outside. Similarly
                            in the aftermath of a terrorist attack on a soft target it would capture the amount of
                            people with some form of PTSD (post-traumatic stress disorder) who are afraid of venturing
                          ...
                          <Table>
                            ...
                            <TableBody>
                              <TableRow>
                                ...
                                <TableCell>{t("learning.impact.sb.1", "< 100 000")}</TableCell>
                                <TableCell>{t("learning.impact.sb.2", "100 001 – 1 000 000")}</TableCell>
                                <TableCell>{t("learning.impact.sb.3", "1 000 001 – 1 000 000")}</TableCell>
                                <TableCell>{t("learning.impact.sb.4", "10 000 001 – 100 000 000")}</TableCell>
                                <TableCell>{t("learning.impact.sb.5", "> 100 000 000")}</TableCell>
                              </TableRow>
                            </TableBody>
                            <TableFooter>
                              <TableRow>
                                <TableCell colSpan={10}>
                                  <Trans i18nKey="learning.impact.sb.footer">
                                    Unit: person days (number of people multiplied by days of impact)
                                  </Trans>
                                </TableCell>
                              </TableRow>
                            </TableFooter>
                  ...
                  <Typography variant="h6" paragraph>
                    ...
                    <Trans i18nKey="learning.impact.sc.title">Sc - Damage to the reputation of Belgium</Trans>
                  </Typography>
                  <Box sx={{ height: collapsed.sc ? "auto" : 0 }}>
                    <Grow in={collapsed.sc} style={{ transformOrigin: "0 0 0" }}>
                      <Box sx={{ mb: 8, ml: 3 }}>
                        <Typography variant="body1" paragraph>
                          <Trans i18nKey="learning.impact.sc.introduction.1">
                            This indicator comprises the significance and duration of a reputational loss for Belgium
                            abroad. Damage to Belgium’s reputation could, for example, lead to a situation where other
                            countries refuse to enter into bilateral, multilateral and international agreements with it,
                            or where its status as a business/tourism destination is severely compromised.
                          </Trans>
                        </Typography>
                        <Typography variant="body1" paragraph>
                          <Trans i18nKey="learning.impact.sc.introduction.2">
                            This indicator qualitatively takes into account the significance of the reputational loss
                            and its duration.
                          </Trans>
                        </Typography>
                  ...
                  <Box sx={{ height: collapsed.sd ? "auto" : 0 }}>
                    <Grow in={collapsed.sd} style={{ transformOrigin: "0 0 0" }}>
                      <Box sx={{ mb: 8, ml: 3 }}>
                        <Typography variant="body1" paragraph>
                          <Trans i18nKey="learning.impact.sd.introduction.1">
                            Indicator Sd measures the significance of a loss of confidence in the state in general and
                            its institutions and the share of the population that is losing confidence, as well as a
                            loss of functioning of the state. Such institutions may include the executive, legislative,
                            or legal branches of government as well as state and regional organisations such as public
                            administrations, the armed forces, the police as well as state and semi-state bodies.
                          </Trans>
                        </Typography>
                        <Typography variant="body1" paragraph>
                          <Trans i18nKey="learning.impact.sd.introduction.2">
                            The significance of a loss of confidence is described qualitatively and includes, for
                            instance, the question of whether the loss of confidence extends to individual regional
                            administrative units or to the federal administration in general. It is assumed that a loss
                            of confidence is measurable by the amount of public backlash.
                          </Trans>
                        </Typography>
                  ...
                  <Typography variant="body1" paragraph>
                    <Trans i18nKey="learning.impact.e.introduction">
                      The indicator for the damage area ‘environment’ express the effects of a hazard on the
                      environment. The main effects include water pollution, ground pollution, and changes to the
                      genetic material of organisms or biological diversity.
                    </Trans>
                  </Typography>
                  ...
                  <Typography variant="h6" paragraph>
                    ...
                    <Trans i18nKey="learning.impact.ea.title">Ea - Damaged ecosystems</Trans>
                  </Typography>
                  <Box sx={{ height: collapsed.ea ? "auto" : 0 }}>
                    <Grow in={collapsed.ea} style={{ transformOrigin: "0 0 0" }}>
                      <Box sx={{ mb: 8, ml: 3 }}>
                        <Typography variant="body1" paragraph>
                          <Trans i18nKey="learning.impact.ea.introduction.1">
                            Indicator Ea measures the size and the duration of an adverse event on ecosystems
                            (woodlands, agro ecosystems, watercourses, lakes, wetlands etc.), which are seriously
                            damaged as a result and which will recover very slowly, if ever. Effects may be caused, for
                            instance, through chemical or radiological pollution, through biological or non-biological
                            contamination, e.g. due to alien invasive species, or through physical damage, such as
                            erosion.
                          </Trans>
                        </Typography>
                        <Typography variant="body1" paragraph>
                          <Trans i18nKey="learning.impact.ea.introduction.2">
                            Impacts are understood as damage to ecosystems and/or adverse effects on ecosystem services.
                          </Trans>
                        </Typography>
                        <Typography variant="body1" paragraph>
                          <Trans i18nKey="learning.impact.ea.introduction.3">
                            An ecosystem is damaged if, for example, the natural balance is upset considerably or the
                            soil fertility is significantly compromised. For example, heavy chemical pollution of
                            surface waters is measured with the indicator Ea. If the water level of a lake significantly
                            drops as a result of drought, but without damaging the flora and the fauna in the medium to
                            long term, this is not considered as an adverse impact on the ecosystem.
                          </Trans>
                        </Typography>
                        <Typography variant="body1" paragraph>
                          <Trans i18nKey="learning.impact.ea.introduction.4">
                            The impairment of ecosystem services should be only considered if the restriction is not
                            covered by other indicators (e.g. their use for leisure and recreation). If drought leads to
                            restrictions on the supply of drinking water from surface water among sections of the
                            population, this is recorded by the indicator Sa – Supply shortfalls and disruptions. The
                            economic impact of ecosystem damage is not covered by the indicator Ea but by the economic
                            indicators Fa (Financial assest damages) and Fb (Reduction of economic performance).
                          </Trans>
                        </Typography>
                        <Typography variant="body1" paragraph>
                          <Trans i18nKey="learning.impact.ea.introduction.5">
                            The unit for measuring adverse effects is the area x year (km2 x year). It is calculated by
                            multiplying the affected area with the number of years that the adverse effect lasts. If an
                            area is under the influence of multiple effects, it is only counted once.
                          </Trans>
                        </Typography>
                        <Typography variant="body1" paragraph>
                          <Trans i18nKey="learning.impact.ea.introduction.6">
                            The duration of the impairment is the length of time during which the ecosystem persists or
                            the restrictions on its use (e.g. restrictions of cultivation on agricultural land) remain
                            in place. The cycle of different stages of an ecosystem, e.g. succession stages in managed
                            forests, should be taken into account. An ecosystem is regarded as damaged until its
                            condition returns to ‘normal’. For instance, in the case of a forest damaged by an extensive
                            fire, the duration is the time until the re-establishment of the early succession stages.
                          </Trans>
                        </Typography>
                  ...
                  <Typography variant="body1" paragraph>
                    <Trans i18nKey="learning.impact.f.introduction">
                      Economic effects and damages are counted as financial asset damages (Fa), and the reduction of
                  ...
                  <Typography variant="h6" paragraph>
                    ...
                    <Trans i18nKey="learning.impact.fa.title">Fa - Financial asset damages</Trans>
                  </Typography>
                  <Box sx={{ height: collapsed.fa ? "auto" : 0 }}>
                    <Grow in={collapsed.fa} style={{ transformOrigin: "0 0 0" }}>
                      <Box sx={{ mb: 8, ml: 3 }}>
                        <Typography variant="body1" paragraph>
                          <Trans i18nKey="learning.impact.fa.introduction.1">
                            Damage indicator Fa measures losses to existing assets and the cost of coping.
                          </Trans>
                        </Typography>
                        <Typography variant="body1" paragraph>
                          <Trans i18nKey="learning.impact.fa.introduction.2">
                            Assets include both tangible assets and financial assets. This indicator counts all damage
                            to assets even if, for example, insurance companies or the State settle the costs.
                          </Trans>
                        </Typography>
                        <Typography variant="body1" paragraph>
                          <Trans i18nKey="learning.impact.fa.introduction.3">
                            Cost of coping includes the cost of emergency services, emergency shelters, and provision of
                            care for people in need of assistance.
                          </Trans>
                        </Typography>
                        <Typography variant="body1" paragraph>
                          <Trans i18nKey="learning.impact.fa.introduction.4">
                            The example used to illustrate this indicator is flooding. Such an event causes damage to
                            multiple buildings and a factory. This runs up costs for pumping out basements and removing
                            rubble and driftwood (cost of coping). The physical damage leads to financial losses as the
                            value of the buildings and equipment is now diminished.
                          </Trans>
                        </Typography>
                        <Typography variant="body1" paragraph>
                          <Trans i18nKey="learning.impact.fa.introduction.5">
                            Depending on the effects of the hazard, various perspectives can be adopted regarding the
                            financial losses:
                          </Trans>
                        </Typography>
                        <ul>
                          <li>
                            <Typography variant="body1" paragraph>
                              <Trans i18nKey="learning.impact.fa.introduction.6">
                                macroeconomic: nationwide cost of coping and damage to national wealth.
                              </Trans>
                            </Typography>
                          </li>
                          <li>
                            <Typography variant="body1" paragraph>
                              <Trans i18nKey="learning.impact.fa.introduction.7">
                                individual or small-scale: cost of coping and financial losses for individuals or within
                                a spatially limited unit.
                              </Trans>
                            </Typography>
                          </li>
                        </ul>
                          ...
                          <Table>
                            ...
                            <TableBody>
                              <TableRow>
                                ...
                                <TableCell>{t("learning.impact.fa.1", "≤ 50 million")}</TableCell>
                                <TableCell>{t("learning.impact.fa.2", "50 – 500 million")}</TableCell>
                                <TableCell>{t("learning.impact.fa.3", "0.5 – 5 billion")}</TableCell>
                                <TableCell>{t("learning.impact.fa.4", "5 – 50 billion")}</TableCell>
                                <TableCell>{t("learning.impact.fa.5", "> 50 billion")}</TableCell>
                              </TableRow>
                            </TableBody>
                            <TableFooter>
                              <TableRow>
                                <TableCell colSpan={10}>
                                  <Trans i18nKey="learning.impact.fa.footer">Unit: EURO</Trans>
                                </TableCell>
                              </TableRow>
                            </TableFooter>
                          </Table>
                  ...
                  <Typography variant="h6" paragraph>
                    ...
                    <Trans i18nKey="learning.impact.fb.title">Fb - Reduction of economic performance</Trans>
                  </Typography>
                  <Box sx={{ height: collapsed.fb ? "auto" : 0 }}>
                    <Grow in={collapsed.fb} style={{ transformOrigin: "0 0 0" }}>
                      <Box sx={{ mb: 8, ml: 3 }}>
                        <Typography variant="body1" paragraph>
                          <Trans i18nKey="learning.impact.fb.introduction.1">
                            Damage indicator Fb includes indirect economic effects that reduce value creation in
                            Belgium. While Fa – Financial losses and cost of coping relates to the cost of coping and
                            damage to existing assets, Fb takes into account the consequences for future value creation.
                          </Trans>
                        </Typography>
                        <Typography variant="body1" paragraph>
                          <Trans i18nKey="learning.impact.fb.introduction.2">
                            The example used to illustrate this indicator is flooding (cf. example in Fa). Due to the
                            damage caused by such an event, the affected company has zero output for several weeks and
                            therefore suffers a loss of income.
                          </Trans>
                        </Typography>
                        <Typography variant="body1" paragraph>
                          <Trans i18nKey="learning.impact.fb.introduction.3">
                            Depending on the effects of the hazard, various perspectives can be adopted regarding
                            financial losses:
                          </Trans>
                        </Typography>
                        <ul>
                          <li>
                            <Typography variant="body1" paragraph>
                              <Trans i18nKey="learning.impact.fb.introduction.4">
                                macroeconomic: the sum of domestic value creation is used as an indicator of total
                                economic performance. It is quantified in terms of Gross Domestic Product (GDP). Thus, a
                                reduction of economic performance corresponds to a decline in GDP.
                              </Trans>
                            </Typography>
                          </li>
                          <li>
                            <Typography variant="body1" paragraph>
                              <Trans i18nKey="learning.impact.fb.introduction.5">
                                individual or small-scale: reduction of economic performance for individuals or within a
                        ...
                        <Typography variant="body1" paragraph>
                          <Trans i18nKey="learning.impact.fb.introduction.6">
                            For this reason and for ease of evaluation for experts without a financial background,
                            multiple equivalent interpretations of the damage classes are provided.
                          </Trans>
                        </Typography>
                        ...
                        <TableContainer component={Paper}>
                          <Table>
                            ...
                            <TableBody>
                              <TableRow>
                                <TableCell>{t("learning.impact.fb.a.name", "Euro")}</TableCell>
                                <TableCell>{t("learning.impact.fb.a.0", "No Impact")}</TableCell>
                                <TableCell>{t("learning.impact.fb.a.1", "≤ 50 million")}</TableCell>
                                <TableCell>{t("learning.impact.fb.a.2", "50 - 500 million")}</TableCell>
                                <TableCell>{t("learning.impact.fb.a.3", "0.5 - 5 billion")}</TableCell>
                                <TableCell>{t("learning.impact.fb.a.4", "5 - 50 billion")}</TableCell>
                                <TableCell>{t("learning.impact.fb.a.5", "> 50 billion")}</TableCell>
                              </TableRow>
                              <TableRow>
                                <TableCell>
                                  {t("learning.impact.fb.b.name", "Governmental debt (% of GDP, basis of 115%)")}
                                </TableCell>
                                <TableCell>{t("learning.impact.fb.b.0", "No Impact")}</TableCell>
                                <TableCell>{t("learning.impact.fb.b.1", "+ <1%")}</TableCell>
                                <TableCell>{t("learning.impact.fb.b.2", "+ 1-3%")}</TableCell>
                                <TableCell>{t("learning.impact.fb.b.3", "+ 3-7%")}</TableCell>
                                <TableCell>{t("learning.impact.fb.b.4", "+ 7-10%")}</TableCell>
                                <TableCell>{t("learning.impact.fb.b.5", "+ >10%")}</TableCell>
                              </TableRow>
                              <TableRow>
                                <TableCell>{t("learning.impact.fb.c.name", "Growth of unemployment")}</TableCell>
                                <TableCell>{t("learning.impact.fb.c.0", "No Impact")}</TableCell>
                                <TableCell>{t("learning.impact.fb.c.1", "<5%")}</TableCell>
                                <TableCell>{t("learning.impact.fb.c.2", "5-10%")}</TableCell>
                                <TableCell>{t("learning.impact.fb.c.3", "10-30%")}</TableCell>
                                <TableCell>{t("learning.impact.fb.c.4", "30-70%")}</TableCell>
                                <TableCell>{t("learning.impact.fb.c.5", "> 70%")}</TableCell>
                              </TableRow>
                              <TableRow>
                                <TableCell>{t("learning.impact.fb.d.name", "GDP Growth")}</TableCell>
                                <TableCell>{t("learning.impact.fb.d.0", "No Impact")}</TableCell>
                                <TableCell>{t("learning.impact.fb.d.1", "2%")}</TableCell>
                                <TableCell>{t("learning.impact.fb.d.2", "0-2%")}</TableCell>
                                <TableCell>{t("learning.impact.fb.d.3", "(-2) – 0%")}</TableCell>
                                <TableCell>{t("learning.impact.fb.d.4", "(-10) – (-2)%")}</TableCell>
                                <TableCell>{t("learning.impact.fb.d.5", "< (-10)%")}</TableCell>
                              </TableRow>
                              <TableRow>
                                <TableCell>{t("learning.impact.fb.e.name", "Inflation (basis of 2%)")}</TableCell>
                                <TableCell>{t("learning.impact.fb.e.0", "No Impact")}</TableCell>
                                <TableCell>{t("learning.impact.fb.e.1", "Δ 1%")}</TableCell>
                                <TableCell>{t("learning.impact.fb.e.2", "Δ 3%")}</TableCell>
                                <TableCell>{t("learning.impact.fb.e.3", "Δ 5%")}</TableCell>
                                <TableCell>{t("learning.impact.fb.e.4", "Δ 10%")}</TableCell>
                                <TableCell>{t("learning.impact.fb.e.5", "Δ >10%")}</TableCell>
                              </TableRow>
                              <TableRow>
                                <TableCell>
                                  {t("learning.impact.fb.f.name", "Consumer confidence (basis of -5)")}
                                </TableCell>
                                <TableCell>{t("learning.impact.fb.f.0", "No Impact")}</TableCell>
                                <TableCell>{t("learning.impact.fb.f.1", "-1")}</TableCell>
                                <TableCell>{t("learning.impact.fb.f.2", "-5")}</TableCell>
                                <TableCell>{t("learning.impact.fb.f.3", "-10")}</TableCell>
                                <TableCell>{t("learning.impact.fb.f.4", "-25")}</TableCell>
                                <TableCell>{t("learning.impact.fb.f.5", ">-25")}</TableCell>
                              </TableRow>
                            </TableBody>
                          </Table>
                        </TableContainer>
